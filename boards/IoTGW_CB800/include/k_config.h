...
#define CSK_CPU_STACK_EXTRAL    1024//68
...
#define RHINO_CONFIG_USER_HOOK_FOR_LWIP      1
...
#ifdef CONFIG_DYN_TASK_STACK_SIZE
#define RHINO_CONFIG_K_DYN_TASK_STACK        CONFIG_DYN_TASK_STACK_SIZE
#else
