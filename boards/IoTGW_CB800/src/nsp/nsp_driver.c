...
//#define QUASI_MODE //�蝜�怀�踽�宒粒蚚QUASIㄛ③妏蚚森隅砱
//===========================================================
...
{
//設置為輸出低電平 Set to output low level
...
{
    //設置為輸出高電平 Set to output High level
...
{
//設置延遲時間 100us;  Delay time 100 us
    udelay(100);
}
...
{
//設置延遲時間 300us;  Delay time 300 us
    udelay(300);
}
...
{
//設置延遲時間 500us;  Delay time 500 us
    udelay(500);
}
//===========================================================
//protocol
