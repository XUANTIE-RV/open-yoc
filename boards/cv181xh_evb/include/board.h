...
#ifndef CONFIG_BOARD_BLE
#define CONFIG_BOARD_BLE 0
#endif
...
#define CONFIG_BOARD_AMP_LOAD_FW 0
#endif
...
#endif
/* since ios is pull up directly, all ios should define to NULL for wifi_demo */
#define WLAN_ENABLE_PIN     0xFFFFFFFF   //PG12
