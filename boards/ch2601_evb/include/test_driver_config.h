...
/* pmu wakeup time config */
#define TIMER_WAKEUP_NUM    TIM0_Wakeupn
#define RTC_WAKEUP_NUM      RTC0_Wakeupn
#define CONFIG_RTC_CCVR     (CSKY_RTC0_BASE)
#define CONFIG_RTC_CMR      (CSKY_RTC0_BASE + 0x4)
...
/* GPIO case config */
#define GPIO_INTR_LOW_LEVEL_EN       0x1
#define GPIO_INTR_HIGH_LEVEL_EN      0x1
#define GPIO_INTR_FALLING_EDGE_EN    0x1
#define GPIO_INTR_RISING_EDGE_EN     0x1
#define GPIO_PIN_ENABLE_DEBONCE_EN   0x1
#define GPIO_PIN_WRITE_EN            0x1
#define GPIO_PIN_TOGGLE_EN           0x1
#define GPIO_PIN_READ_EN             0x1
#define GPIO_PORT_WRITE_EN           0x1
#define GPIO_PORT_READ_EN            0x1
...
/* IIC case config */
#define IIC_TEST_AT24C64_WRITE_READ_SYNC_EN    0x1
#define IIC_TEST_AT24C64_WRITE_READ_ASYNC_EN   0X1
#define IIC_TEST_AT24C64_WRITE_READ_MEM_EN     0x1
#define IIC_TEST_CONFIG_INTERFACE_EN           0x1

/* SPI case config */
#define SPI_TEST_INTERFACES_EN           0x1
#define SPI_TEST_TRANSFER_POLLING_EN     0x1
#define SPI_TEST_TRANSFER_INTR_EN        0x1

/* QSPI case config */
#define QSPI_TEST_INTERFACES_EN          0x1
#define QSPI_TEST_TRANSFER_POLLING_EN    0x1
#define QSPI_TEST_TRANSFER_INTR_EN       0x1
#define QSPI_TEST_TRANSFER_DMA_EN        0x1

/* ADC case config */
#define ADC_TEST_INTERFACES_EN           0x1
#define ADC_TEST_SYNC_EN                 0x1
#define ADC_TEST_INTR_EN                 0x1
#define ADC_TEST_DMA_EN                  0x1
