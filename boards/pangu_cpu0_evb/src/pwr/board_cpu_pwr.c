...
#ifdef CONFIG_CSI_V1
            csi_vic_set_wakeup_irq(TIMER0_INT0_IRQn);
            csi_vic_set_wakeup_irq(UART1_HS_IRQn);
#endif
#ifdef CONFIG_CSI_V2 
            csi_vic_set_wakeup_irq(DW_TIMER0_INT0_IRQn);
            csi_vic_set_wakeup_irq(DW_UART1_HS_IRQn);
#endif
            __WFI();
#endif
            break;
