...
ifeq ($(board), xiaohui)
CFLAGS += -DCONFIG_SYSTICK_HZ=100 -DCONFIG_BOARD_XIAOHUI_EVB=1
endif
ifeq ($(board), smartl)
CFLAGS += -DCONFIG_SYSTICK_HZ=100 -DCONFIG_BOARD_SMARTL_EVB=1
endif
ifeq ($(board), smartm)
CFLAGS += -DCONFIG_SYSTICK_HZ=100 -DCONFIG_BOARD_SMARTM_EVB=1
endif
else
