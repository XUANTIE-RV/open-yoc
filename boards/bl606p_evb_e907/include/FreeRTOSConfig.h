...
#define CSK_CPU_STACK_EXTRAL    (128 + 512 + 40)    // float and vector registers additional
#else
#define CSK_CPU_STACK_EXTRAL    (128)               // float registers additional (32 * 4)
#endif
...
#endif
#define configMINIMAL_STACK_SIZE    ( ( unsigned short ) (256 + CSK_CPU_STACK_EXTRAL / 4) ) //stack depth
...
#define configTIMER_TASK_STACK_DEPTH    (1024 + (CSK_CPU_STACK_EXTRAL / 4))
