...
public:
    ...
    void     unpack(const uint8_t buf[4]);
...
public:
    ...
    void unpack(const uint8_t buf[5]);
...
public:
    ...
    void unpack(const uint8_t buf[12]);
...
public:
    ...
    void unpack(const uint8_t buf[9]);

public:
    uint32_t packet_start_code;              // 24
    uint8_t  stream_id;                      // 8
    ...
    uint8_t  pes_extention_flag;             // 1
    uint8_t  header_data_length;             // 8
};
...
public:
    ...
    void unpack(const uint8_t buf[2]);
