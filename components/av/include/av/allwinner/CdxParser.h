...
#include <stdint.h>
#include <string.h>
#include <av/allwinner/CdxTypes.h>
#include <av/allwinner/cdx_log.h>
#include <av/allwinner/CdxStream.h>
...
enum EPARSERNOTIFY  //* notify.
{
    ...
    PARSER_NOTIFY_HLS_GET_STREAM_CACHE_UNDERFLOW_FLAG,
    PARSER_NOTIFY_MAX,
};
