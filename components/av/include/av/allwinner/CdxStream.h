...
#include <av/allwinner/CdxBinary.h>
#include <av/allwinner/CdxAtomic.h>
#include <av/allwinner/CdxKeyedVector.h>
...
enum CdxStreamCommandE
{
    ...
    STREAM_CMD_SET_MEDIAFLAG = 0x124,
};
...
static inline cdx_int32 CdxStreamSkip(CdxStreamT *stream, cdx_uint32 len)
{
    ...
    else
    {
        ...
        for (i = 0; i < 10; i++)
        {
            unitSize = (skipSize > 4096) ? 4096 : skipSize;
