...
#include <av/allwinner/cdc_log.h>
...
/*
    Set para area...
*/
    SOUND_CONTROLL_SET_OPTION_START = 100,
    SOUND_CONTROLL_SET_CLBK_EOS,
/*
    Get para area...
*/
    SOUND_CONTROLL_GET_OPTION_START = 200,
/*
    Query area...
*/
    SOUND_CONTROLL_QUERY_OPTION_START = 300,
    SOUND_CONTROLL_QUERY_IF_GAPLESS_PLAY,
}SoundCtrlCmd;
