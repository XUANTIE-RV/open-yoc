...
#ifndef _DRV_SPU_IIC_H_
#define _DRV_SPU_IIC_H_
...
/**
  \brief       Start transmitting data as I2C Master.
               ...
               \ref drv_spu_iic_get_status can get operating status.
  \param[in]   handle         iic handle to operate.
...
/**
  ...
  \return      0 for success, negative for error code
*/
int32_t drv_spu_iic_slave_send(iic_handle_t handle, const void *data, uint32_t num);
