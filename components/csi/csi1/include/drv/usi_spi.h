...
#ifndef _DRV_SPU_USI_H_
#define _DRV_SPU_USI_H_
...
/****** SPI Event *****/
typedef enum {
    SPI_EVENT_TRANSFER_COMPLETE = 0,   ///< Data Transfer completed. Occurs after call to drv_usi_spi_send, drv_usi_spi_receive, or drv_usi_spi_transfer to indicate that all the data has been transferred. The driver is ready for the next transfer operation
    SPI_EVENT_TX_COMPLETE,              ///< Data Transfer completed. Occurs after call to drv_usi_spi_send, drv_usi_spi_receive, or drv_usi_spi_transfer to indicate that all the data has been transferred. The driver is ready for the next transfer operation
    SPI_EVENT_RX_COMPLETE,              ///< Data Transfer completed. Occurs after call to drv_usi_spi_send, drv_usi_spi_receive, or drv_usi_spi_transfer to indicate that all the data has been transferred. The driver is ready for the next transfer operation
...
\brief         sending data to SPI transmitter,(received data is ignored).
               ...
               \ref drv_usi_spi_get_status can get operation status.
