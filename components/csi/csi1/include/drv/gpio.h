...
extern "C" {
#endif
/// definition for gpio pin_handle.
...
/**
  \brief       De-initialize GPIO pin_handle.stops operation and releases the software resources used by the handle.
  \param[in]   handle    gpio pin_handle to operate.
  \return      error code
*/
...
/**
  ...
  \param[in]   pin       gpio pin_handle to operate.
