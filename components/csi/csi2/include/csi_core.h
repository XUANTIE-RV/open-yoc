...
__STATIC_INLINE const char* csi_get_cpu_name()
{
	...
	return "e901b-cp";
#elif CONFIG_CPU_XUANTIE_E901_M_CP
	return "e901m-cp";
#elif CONFIG_CPU_XUANTIE_E901_BM_CP
	return "e901bm-cp";
#elif CONFIG_CPU_XUANTIE_E901MINI_CP
	return "e901mini-cp";
#elif CONFIG_CPU_XUANTIE_E901MINI_B_CP
	return "e901minib-cp";
#elif CONFIG_CPU_XUANTIE_E901MINI_ZM_CP
	return "e901minizm-cp";
#elif CONFIG_CPU_XUANTIE_E901MINI_BZM_CP
	return "e901minibzm-cp";
