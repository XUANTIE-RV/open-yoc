...
#define DW_SPI_FIFO_MAX_LV      0x08
...
#define DW_SPI_SPIMSSEL_MASTER 0x1
#define DW_SPI_SPIMSSEL_SLAVE  0x0
...
//    __IOM uint8_t SPIMSSEL;           /* Offset: 0x0A0 (R/W)  SPI is Master or Slave Select Register */
//RX_SAMPLE_DLY/* Offset: 0x0fc (R/W)[7:0]Receive Data (rxd) Sample Delay.This register is used to delay the sample of the rxd input signal
} dw_spi_reg_t;

#define AP_PERI_MASTER_ADDR 0x4000302C
#define SPI0_MASTER_MODE 0X01
#define SPI1_MASTER_MODE 0X02
#define SPI0_IS_SLAVE_MODE (AP_COM->PERI_MASTER_SELECT & SPI0_MASTER_MODE)
#define SPI1_IS_SLAVE_MODE (AP_COM->PERI_MASTER_SELECT & SPI1_MASTER_MODE)
