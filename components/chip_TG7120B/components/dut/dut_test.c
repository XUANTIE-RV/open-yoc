...
/*
    ...
    Here, we use  XIP address to get value directly.
    Since aos_malloc depend on aos system init, but dut_hal_xtalcap_get will be called
    in hal_rfphy_init(), in that time aos was not init yet.
*/
