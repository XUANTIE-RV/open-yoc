...
#define DW_SPI_DFS_MASK_V3      0x0f
#define DW_SPI_DFS_SHIFT_V3     0x00
#define DW_SPI_DFS_MASK_V4      0x1f
#define DW_SPI_DFS_SHIFT_V4     0x10
...
#define DW_SPI_TXFIFO_LV        0x0f
#define DW_SPI_RXFIFO_LV        0x0f
#define DW_SPI_RXFIFO_NOT_EMPTY 0x08
#define DW_SPI_START_RX         0x0
#define DW_SPI_FIFO_MAX_LV      0x10
...
#define DW_SPI_MCLK             4096000   /* 4.096M */
...
typedef struct {
    ...
    __IM uint32_t VERSION;          /* Offset: 0x05C (R/W)  IP Version */
