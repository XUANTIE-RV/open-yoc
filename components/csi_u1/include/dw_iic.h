...
/* IC_CON register */
#define DW_IIC_CON_DEFAUL           0x73
#define DW_IIC_CON_SLAVE_DISABLE    (1 << 6)
...
typedef struct {
    ...
    __IM  uint32_t IC_SDA_HOLD;               /* Offset: 0x07c (R/ )   */
    ...
    __IOM uint32_t IC_SDA_SETUP;              /* Offset: 0x094 (R/W)  I2C SDA Setup Time */
    __IOM uint32_t IC_ACK_GENERAL_CALL;       /* Offset: 0x098 (R/W)  I2C ACK*/
    __IOM uint32_t IC_ENABLE_STATUS;          /* Offset: 0x09c (R/W)  I2C Enable Status */
    __IOM uint32_t IC_FS_SPKLEN;              /* Offset: 0x0a0 (R/W)  I2C SPKLEN in Formal Speed mode*/
    __IOM uint32_t IC_HS_SPKLEN;              /* Offset: 0x0a4 (R/W)  I2C SPKLEN in High Speed mode */
} dw_iic_reg_t;
