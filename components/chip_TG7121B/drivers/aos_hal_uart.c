...
#define HAL_UART_RINGBUF_LEN 80
...
static hal_uart_priv_t uart_list[3];
...
int32_t hal_uart_init(uart_dev_t *uart)
{
    ...
    usart_handle = csi_usart_initialize(uart->port, (usart_event_cb_t)uart_event_cb);
