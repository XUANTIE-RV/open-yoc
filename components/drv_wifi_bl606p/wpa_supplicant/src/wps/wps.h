...
#define WPS_IE_PROBE_REQUEST_MAX_LEN       256
#define WPS_IE_ASSOCIATION_REQUEST_MAX_LEN 32

#define WPS_TASK_STACK_DEPTH 2048

#define WPS_EVENT_QUEUE_CAPACITY 2
...
struct wps_sm {
    ...
    BL_TaskHandle_t wps_task_hdl;
    u8 wps_ie_probe_request[WPS_IE_PROBE_REQUEST_MAX_LEN];
    u16 wps_ie_probe_request_len;
    u8 wps_ie_association_request[WPS_IE_ASSOCIATION_REQUEST_MAX_LEN];
    u16 wps_ie_association_request_len;
    bl_wifi_timer_t wps_eapol_start_timer;
    uint64_t start_tick;
    BL_MessageQueue_t event_queue;
    BL_Timer_t timeout_timer;
    //StaticTimer_t timeout_timer_buffer;
    BL_Timer_t success_cb_timer;
