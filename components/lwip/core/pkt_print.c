           ...
           case NL_IP4:
              if( 0 == ip4_ptr->offset )
              {
                ...
                if((pktprint_debug_level == 2)||((pktprint_debug_level == 1)&&(filter_flag == 0)))
                {
                    ...
                    note_ptr, pbuf, netif,
                    ((uint8_t *)&ip4_ptr->ip_src)[3],
                    ((uint8_t *)&ip4_ptr->ip_src)[2],
                    ((uint8_t *)&ip4_ptr->ip_src)[1],
                    ((uint8_t *)&ip4_ptr->ip_src)[0],
                    ((uint8_t *)&ip4_ptr->ip_dst)[3],
                    ((uint8_t *)&ip4_ptr->ip_dst)[2],
                    ((uint8_t *)&ip4_ptr->ip_dst)[1],
                    ((uint8_t *)&ip4_ptr->ip_dst)[0],
                    ip4_ptr->id, info_str,
