...
/******************************************************************************
 * @file     wj_alkaid_pmu.h
 * @brief    head file for alkaid pmu
 * @version  V1.0
 * @date     17. Feb 2020
 ******************************************************************************/
#ifndef _WJ_ALKAID_PMU_H_
#define _WJ_ALKAID_PMU_H_
...
#define WJ_IP_CTRL_I2S4_Pos                      (17U)
#define WJ_IP_CTRL_I2S4_Msk                      (0x1U << WJ_IP_CTRL_I2S4_Pos)
#define WJ_IP_CTRL_I2S4                          WJ_IP_CTRL_I2S4_Msk

#define WJ_IP_CTRL_I2S5_Pos                      (18U)
#define WJ_IP_CTRL_I2S5_Msk                      (0x1U << WJ_IP_CTRL_I2S5_Pos)
#define WJ_IP_CTRL_I2S5                          WJ_IP_CTRL_I2S5_Msk

#define WJ_IP_CTRL_I2S6_Pos                      (19U)
#define WJ_IP_CTRL_I2S6_Msk                      (0x1U << WJ_IP_CTRL_I2S6_Pos)
#define WJ_IP_CTRL_I2S6                          WJ_IP_CTRL_I2S6_Msk
...
static inline void wj_pmu_i2s4_clock_on(wj_pmu_reg_t *pmu_base)
{
    pmu_base->IP_CTRL |= WJ_IP_CTRL_I2S4;
}

static inline void wj_pmu_i2s4_clock_off(wj_pmu_reg_t *pmu_base)
{
    pmu_base->IP_CTRL &= ~WJ_IP_CTRL_I2S4;
}
