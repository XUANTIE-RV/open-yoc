# YOC BLE Mesh Framework

This folder contains all the documents of YOC BLE Mesh.
* Note: breaking changes might be introduced into YOC BLE Mesh on [minor IDF versions](https://docs.espressif.com/projects/esp-idf/en/latest/versions.html)
...
* [Espressif Fast Provisioning using YOC BLE Mesh App](http://download.espressif.com/BLE_MESH/BLE_Mesh_Demo/V0.4_Demo_Fast_Provision/ESP32_BLE_Mesh_Fast_Provision.mp4)
* [Espressif BLE Mesh and Wi-Fi Coexistence](http://download.espressif.com/BLE_MESH/BLE_Mesh_Demo/V0.5_Demo_Coexistence/BLE_MESH_BLE_MESH_%26_WIFI_Coexistence.mp4)
...
### YOC BLE Mesh Development Documentation

* [Getting started with YOC BLE Mesh](BLE-Mesh_Getting_Started_EN.md)
* [YOC BLE Mesh Feature List](BLE-Mesh_Feature_List_EN.md)
