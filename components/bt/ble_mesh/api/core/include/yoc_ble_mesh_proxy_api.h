...
#ifndef _BLE_MESH_BLE_MESH_PROXY_API_H_
#define _BLE_MESH_BLE_MESH_PROXY_API_H_
 ...
 *
 */
bt_err_t ble_mesh_proxy_identity_enable(void);
 ...
 *
 */
bt_err_t ble_mesh_proxy_gatt_enable(void);
 ...
 *
 */
bt_err_t ble_mesh_proxy_gatt_disable(void);

#endif /* _BLE_MESH_BLE_MESH_PROXY_API_H_ */
