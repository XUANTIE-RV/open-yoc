...
typedef union {
    ...
    struct ble_mesh_node_prov_enable_args {
        ble_mesh_prov_bearer_t bearers;
    } node_prov_enable;
    ...
    struct ble_mesh_set_device_name_args {
        char name[BLE_MESH_BLE_MESH_DEVICE_NAME_MAX_LEN];
    } set_device_name;
    ...
    struct ble_mesh_provisioner_set_prov_net_idx_args {
        ble_mesh_prov_data_info_t prov_data;
    } set_prov_data_info;
    struct ble_mesh_provisioner_set_node_name_args {
        int index;
        char name[BLE_MESH_BLE_MESH_NODE_NAME_MAX_LEN];
    } set_node_name;
...
ble_mesh_model_t *btc_ble_mesh_model_find(const ble_mesh_elem_t *elem,
        uint16_t id);
