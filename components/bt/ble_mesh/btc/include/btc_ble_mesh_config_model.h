...
typedef union {
    struct ble_mesh_clg_client_get_state_reg_args {
        ble_mesh_client_common_param_t *params;
...
int btc_ble_mesh_config_client_get_state(ble_mesh_client_common_param_t *params, ble_mesh_cfg_client_get_state_t *get_state,
        ble_mesh_cfg_client_cb_param_t *cfg_client_cb);

int btc_ble_mesh_config_client_set_state(ble_mesh_client_common_param_t *params, ble_mesh_cfg_client_set_state_t *set_state,
        ble_mesh_cfg_client_cb_param_t *cfg_client_cb);
