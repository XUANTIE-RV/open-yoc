...
#define BLE_MESH_PRINT_E(tag, format, ...)   {LOGE(tag, format, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_W(tag, format, ...)   {LOGW(tag, format, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_I(tag, format, ...)   {LOGI(tag, format, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_D(tag, format, ...)   {LOGD(tag, format, ##__VA_ARGS__); }
#define BLE_MESH_PRINT_V(tag, format, ...)   {LOGD(tag, format, ##__VA_ARGS__); }
