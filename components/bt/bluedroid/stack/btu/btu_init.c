...
#define BTU_TASK_STACK_SIZE             (8096 + BT_TASK_EXTRA_STACK_SIZE)
#define BTU_TASK_PRIO                   (BT_TASK_DEFAULT_PRIORITIES - 3)
...
error_exit:
    BT_LOG_ERROR("%s Unable to allocate resources for bt_workqueue", __func__);
    BTU_ShutDown();
}
