...
extern UINT8 L2CA_PTS_DataWrite (BD_ADDR p_bd_addr, BT_HDR *p_data);
extern BOOLEAN L2CA_PTS_DisconnectReq (BD_ADDR p_bd_addr);
#if (CLASSIC_BT_INCLUDED == TRUE)
...
extern BOOLEAN L2CA_CheckIsCongest(UINT16 fixed_cid, UINT16 conn_id);
extern BOOLEAN L2CA_CheckIsCongest_by_conn_id(UINT16 fixed_cid, UINT16 conn_id);
