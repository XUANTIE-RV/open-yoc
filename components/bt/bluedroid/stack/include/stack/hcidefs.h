...
#define HCI_YOC_GROUP_COMMON    0x01
#define HCI_YOC_GROUP_BLE       0x02
#define HCI_YOC_GROUP_BT        0x03
#define HCI_YOC_GROUP_END       0x07
...
#define HCI_YOC_VENDOR_OPCODE_BUILD(ogf, group, subcode) ((ogf << 10) | (group <<7) | (subcode << 0))
/*
...
// ESP COMMON HCI CMD
#define HCI_VENDOR_COMMON_ECHO_CMD_OPCODE HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_COMMON, HCI_SUBCODE_COMMON_ECHO)

//ESP BLE HCI CMD
/* Multi adv OCF */
#define HCI_BLE_MULTI_ADV_OCF             HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_MULTI_ADV)
/* Batch scan OCF */
#define HCI_BLE_BATCH_SCAN_OCF            HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_BATCH_SCAN)
/* ADV filter OCF */
#define HCI_BLE_ADV_FILTER_OCF            HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_ADV_FILTER)
/* Tracking OCF */
#define HCI_BLE_TRACK_ADV_OCF             HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_TRACK_ADV)
/* Energy info OCF */
#define HCI_BLE_ENERGY_INFO_OCF           HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_ENERGY_INFO)
/* Extended BLE Scan parameters OCF */
#define HCI_BLE_EXTENDED_SCAN_PARAMS_OCF  HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_EXTENDED_SCAN_PARAMS)
/* Long BLE Adv data OCF */
#define HCI_VENDOR_BLE_LONG_ADV_DATA      HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_LONG_ADV)
/* BLE update duplicate scan exceptional list */
#define HCI_VENDOR_BLE_UPDATE_DUPLICATE_EXCEPTIONAL_LIST  HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_DUPLICATE_EXCEPTIONAL_LIST)
#define HCI_VENDOR_BLE_SET_ADV_FLOW_CONTROL        HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_SET_ADV_FLOW_CONTROL)
#define HCI_VENDOR_BLE_ADV_REPORT_FLOW_CONTROL     HCI_YOC_VENDOR_OPCODE_BUILD(HCI_VENDOR_OGF, HCI_YOC_GROUP_BLE, HCI_SUBCODE_BLE_ADV_REPORT_FLOW_CONTROL)
//ESP BT HCI CMD
...
#define HCI_ERR_YOC_VENDOR_FAIL                         0xE0
...
#define HCI_FEATURE_INQ_RYOC_TX_MASK     0x02
#define HCI_FEATURE_INQ_RYOC_TX_OFF      7
#define HCI_INQ_RYOC_TX_SUPPORTED(x)     ((x)[HCI_FEATURE_INQ_RYOC_TX_OFF] & HCI_FEATURE_INQ_RYOC_TX_MASK)
...
#define HCI_EXT_FEATURE_INQ_RYOC_NOTIF_MASK     0x10
#define HCI_EXT_FEATURE_INQ_RYOC_NOTIF_OFF      0
#define HCI_INQ_RYOC_NOTIF_SUPPORTED(x) ((x)[HCI_EXT_FEATURE_INQ_RYOC_NOTIF_OFF] & HCI_EXT_FEATURE_INQ_RYOC_NOTIF_MASK)
...
#define HCI_SUPP_COMMANDS_READ_EXT_INQUIRY_RYOC_MASK   0x01
#define HCI_SUPP_COMMANDS_READ_EXT_INQUIRY_RYOC_OFF    17
#define HCI_READ_EXT_INQUIRY_RYOC_SUPPORTED(x)   ((x)[HCI_SUPP_COMMANDS_READ_EXT_INQUIRY_RYOC_OFF] & HCI_SUPP_COMMANDS_READ_EXT_INQUIRY_RYOC_MASK)

#define HCI_SUPP_COMMANDS_WRITE_EXT_INQUIRY_RYOC_MASK  0x02
#define HCI_SUPP_COMMANDS_WRITE_EXT_INQUIRY_RYOC_OFF   17
#define HCI_WRITE_EXT_INQUIRY_RYOC_SUPPORTED(x)  ((x)[HCI_SUPP_COMMANDS_WRITE_EXT_INQUIRY_RYOC_OFF] & HCI_SUPP_COMMANDS_WRITE_EXT_INQUIRY_RYOC_MASK)
