...
#define BT_LOG_ERROR(format, ... )             {LOGE("BT_LOG", format, ##__VA_ARGS__); }
#define BT_LOG_WARN(format, ... )              {LOGW("BT_LOG", format, ##__VA_ARGS__); }
#define BT_LOG_INFO(format, ... )              {LOGI("BT_LOG", format, ##__VA_ARGS__); }
#define BT_LOG_DEBUG(format, ... )             {LOGD("BT_LOG", format, ##__VA_ARGS__); }
#define BT_LOG_VERBOSE(format, ... )           {LOGD("BT_LOG", format, ##__VA_ARGS__); }
...
#define BT_LOG_WARN(fmt, args...)
#define LOG_INFO(fmt, args...)
#define BT_LOG_DEBUG(fmt, args...)
