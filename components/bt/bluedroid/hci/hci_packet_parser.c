    ...
    uint16_t *sco_buffer_count_ptr)
{
    ...
    if (stream != NULL) {
        ...
        *acl_data_size_ptr = 0;
        *sco_data_size_ptr = 0;
        *acl_buffer_count_ptr = 0;
        *sco_buffer_count_ptr = 0;
    }
    ...
    bt_version_t *bt_version)
{
    ...
    if (stream != NULL) {
        ...
        memset(bt_version, 0, (int)sizeof(bt_version_t));
    }
    osi_free(response);
}
    ...
    bt_bdaddr_t *address_ptr)
{
    ...
    if (stream != NULL) {
        ...
        memset(address_ptr->address, 0, 6);
    }
    ...
    size_t supported_commands_length)
{
    ...
    if (stream != NULL) {
        ...
        memset(supported_commands_ptr, 0, (int)supported_commands_length);
    }
    ...
    size_t feature_pages_count)
{
    ...
    if (stream != NULL) {
        ...
        *page_number_ptr = 0;
        *max_page_number_ptr = 0;
        memset(feature_pages[*page_number_ptr].as_array, 0, (int)sizeof(bt_device_features_t));
    ...
    size_t supported_states_size)
{
    ...
    if (stream != NULL) {
        ...
        memset(supported_states, 0, (int)supported_states_size);
    }
    ...
    bt_device_features_t *supported_features)
{
    ...
    if (stream != NULL) {
        ...
        memset(supported_features->as_array, 0, (int)sizeof(bt_device_features_t));
    }
    osi_free(response);
}
    ...
    uint16_t *ble_default_packet_txtime_ptr)
{
    ...
    if (stream != NULL) {
        ...
        *ble_default_packet_length_ptr = 0;
        *ble_default_packet_txtime_ptr = 0;
    }
    ...
    size_t minimum_bytes_after)
{
    ...
    //const size_t parameter_bytes_we_read_here = 5;
