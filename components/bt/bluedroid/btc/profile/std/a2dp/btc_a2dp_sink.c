...
static void btc_a2dp_sink_audio_handle_stop_decoding(void);
 ...
 **
 *******************************************************************************/
static void btc_a2dp_sink_alarm_data_post(void *argv)
{
...
static bool btc_a2dp_sink_handle_inc_media(tBT_SBC_HDR *p_msg)
{
    ...
    if (!a2dp_sink_local_param.btc_aa_snk_cb.decoder_interface->decode_packet((BT_HDR*)p_msg, &outputBuffer, &outputSize)) {
 ...
 *******************************************************************************/
static void btc_a2dp_sink_audio_handle_start_decoding(void *argv)
{
...
static void btc_a2dp_sink_audio_handle_stop_decoding(void)
{
    ...
    if(a2dp_sink_local_param.btc_aa_snk_cb.player_handle)
...
UINT8 btc_a2dp_sink_enque_buf(BT_HDR *p_pkt)
{
    ...
    if ((p_msg = (tBT_SBC_HDR *) osi_malloc(sizeof(tBT_SBC_HDR) +
        ...
        btc_a2dp_sink_audio_handle_start_decoding(NULL);
    } else {
