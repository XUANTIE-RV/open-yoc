...
bt_err_t yoc_ble_gattc_register_callback(yoc_gattc_cb_t callback)
{
...
bt_err_t yoc_ble_gattc_app_register(uint16_t app_id)
{
    btc_msg_t msg;
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}
...
bt_err_t yoc_ble_gattc_open(yoc_gatt_if_t gattc_if, yoc_bd_addr_t remote_bda, yoc_ble_addr_type_t remote_addr_type, bool is_direct)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.open.remote_bda, remote_bda, BT_BD_ADDR_LEN);
...
bt_err_t yoc_ble_gattc_send_mtu_req (yoc_gatt_if_t gattc_if, uint16_t conn_id)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
bt_err_t yoc_ble_gattc_search_service(yoc_gatt_if_t gattc_if, uint16_t conn_id, yoc_bt_uuid_t *filter_uuid)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    if (filter_uuid) {
        ...
        memcpy(&arg.search_srvc.filter_uuid, filter_uuid, sizeof(yoc_bt_uuid_t));
    } else {
...
yoc_gatt_status_t yoc_ble_gattc_get_service(yoc_gatt_if_t gattc_if, uint16_t conn_id, yoc_bt_uuid_t *svc_uuid,
                                            yoc_gattc_service_elem_t *result, uint16_t *count, uint16_t offset)
{
    BT_BLUEDROID_STATUS_CHECK(BT_BLUEDROID_STATUS_ENABLED);

    if (result == NULL || count == NULL || *count == 0) {
        return YOC_GATT_INVALID_PDU;
    }
...
yoc_gatt_status_t yoc_ble_gattc_get_all_char(yoc_gatt_if_t gattc_if,
                                             uint16_t conn_id,
                                             uint16_t start_handle,
                                             uint16_t end_handle,
                                             yoc_gattc_char_elem_t *result,
...
yoc_gatt_status_t yoc_ble_gattc_get_all_descr(yoc_gatt_if_t gattc_if,
                                              uint16_t conn_id,
                                              uint16_t char_handle,                                            
                                              yoc_gattc_descr_elem_t *result,
                                              uint16_t *count, uint16_t offset)
{
    BT_BLUEDROID_STATUS_CHECK(BT_BLUEDROID_STATUS_ENABLED);
...
yoc_gatt_status_t yoc_ble_gattc_get_char_by_uuid(yoc_gatt_if_t gattc_if, 
                                                 uint16_t conn_id,
                                                 uint16_t start_handle,
                                                 uint16_t end_handle,
...
yoc_gatt_status_t yoc_ble_gattc_get_descr_by_uuid(yoc_gatt_if_t gattc_if,
                                                  uint16_t conn_id,
                                                  uint16_t start_handle,
                                                  uint16_t end_handle,
                                                  yoc_bt_uuid_t char_uuid,
...
yoc_gatt_status_t yoc_ble_gattc_get_descr_by_char_handle(yoc_gatt_if_t gattc_if,
                                                         uint16_t conn_id,
                                                         uint16_t char_handle,
                                                         yoc_bt_uuid_t descr_uuid,
                                                         yoc_gattc_descr_elem_t *result,
...
yoc_gatt_status_t yoc_ble_gattc_get_include_service(yoc_gatt_if_t gattc_if,
                                                    uint16_t conn_id,
                                                    uint16_t start_handle,
                                                    uint16_t end_handle,
                                                    yoc_bt_uuid_t *incl_uuid,
                                                    yoc_gattc_incl_svc_elem_t *result,
                                                    uint16_t *count)
{
    BT_BLUEDROID_STATUS_CHECK(BT_BLUEDROID_STATUS_ENABLED);
...
yoc_gatt_status_t yoc_ble_gattc_get_attr_count(yoc_gatt_if_t gattc_if,
                                               uint16_t conn_id,
                                               yoc_gatt_db_attr_type_t type,
                                               uint16_t start_handle,
                                               uint16_t end_handle,
                                               uint16_t char_handle,
                                               uint16_t *count)
{
    ...
    if ((start_handle == 0 && end_handle == 0) && (type != YOC_GATT_DB_DESCRIPTOR)) {
        *count = 0;
        return YOC_GATT_INVALID_HANDLE;
    }
...
yoc_gatt_status_t yoc_ble_gattc_get_db(yoc_gatt_if_t gattc_if, uint16_t conn_id, uint16_t start_handle, uint16_t end_handle,
                                       yoc_gattc_db_elem_t *db, uint16_t *count)
{
    BT_BLUEDROID_STATUS_CHECK(BT_BLUEDROID_STATUS_ENABLED);
...
bt_err_t yoc_ble_gattc_read_char (yoc_gatt_if_t gattc_if, 
                                   uint16_t conn_id, uint16_t handle,
                                   yoc_gatt_auth_req_t auth_req)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
bt_err_t yoc_ble_gattc_read_multiple(yoc_gatt_if_t gattc_if,
                                      uint16_t conn_id, yoc_gattc_multi_t *read_multi,
                                      yoc_gatt_auth_req_t auth_req)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    if (read_multi->num_attr > 0) {
        ...
        BT_LOG_DEBUG("%s(), the num_attr should not be 0.", __func__);
        return BT_FAIL;
    }
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}
...
bt_err_t yoc_ble_gattc_read_char_descr (yoc_gatt_if_t gattc_if,
                                         uint16_t conn_id, uint16_t handle,
                                         yoc_gatt_auth_req_t auth_req)
{
    btc_msg_t msg;
...
bt_err_t yoc_ble_gattc_write_char(yoc_gatt_if_t gattc_if,
                                   uint16_t conn_id, uint16_t handle,
                                   uint16_t value_len,
                                   uint8_t *value,
                                   yoc_gatt_write_type_t write_type,
                                   yoc_gatt_auth_req_t auth_req)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    arg.write_char.value_len = value_len > YOC_GATT_MAX_ATTR_LEN ? YOC_GATT_MAX_ATTR_LEN : value_len;
    arg.write_char.value = value;
    arg.write_char.write_type = write_type;
    arg.write_char.auth_req = auth_req;

    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), btc_gattc_arg_deep_copy) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_write_char_descr (yoc_gatt_if_t gattc_if,
                                          uint16_t conn_id, uint16_t handle,
                                          uint16_t value_len,
                                          uint8_t *value,
                                          yoc_gatt_write_type_t write_type,
                                          yoc_gatt_auth_req_t auth_req)
{
    ...
    arg.write_descr.value_len = value_len > YOC_GATT_MAX_ATTR_LEN ? YOC_GATT_MAX_ATTR_LEN : value_len;
...
bt_err_t yoc_ble_gattc_prepare_write(yoc_gatt_if_t gattc_if, 
                                      uint16_t conn_id, uint16_t handle,
                                      uint16_t offset,
                                      uint16_t value_len,
                                      uint8_t *value,
                                      yoc_gatt_auth_req_t auth_req)
{
    ...
    arg.prep_write.value_len = value_len > YOC_GATT_MAX_ATTR_LEN ? YOC_GATT_MAX_ATTR_LEN : value_len; // length check ?
...
bt_err_t yoc_ble_gattc_prepare_write_char_descr(yoc_gatt_if_t gattc_if,
                                                 uint16_t conn_id, uint16_t handle,
                                                 uint16_t offset,
                                                 uint16_t value_len,
                                                 uint8_t *value,
                                                 yoc_gatt_auth_req_t auth_req)
{
    ...
    arg.prep_write_descr.value_len = value_len > YOC_GATT_MAX_ATTR_LEN ? YOC_GATT_MAX_ATTR_LEN : value_len; // length check ?
...
bt_err_t yoc_ble_gattc_execute_write (yoc_gatt_if_t gattc_if, uint16_t conn_id, bool is_execute)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
...
bt_err_t yoc_ble_gattc_register_for_notify (yoc_gatt_if_t gattc_if,
                                             yoc_bd_addr_t server_bda, uint16_t handle)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.reg_for_notify.remote_bda, server_bda, sizeof(yoc_bd_addr_t));
    arg.reg_for_notify.handle = handle;

    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_unregister_for_notify (yoc_gatt_if_t gattc_if,
                                               yoc_bd_addr_t server_bda, uint16_t handle)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.unreg_for_notify.remote_bda, server_bda, sizeof(yoc_bd_addr_t));
    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_cache_refresh(yoc_bd_addr_t remote_bda)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.cache_refresh.remote_bda, remote_bda, sizeof(yoc_bd_addr_t));

    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_cache_clean(yoc_bd_addr_t remote_bda)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.cache_clean.remote_bda, remote_bda, sizeof(yoc_bd_addr_t));

    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_cache_assoc(yoc_gatt_if_t gattc_if, yoc_bd_addr_t src_addr, yoc_bd_addr_t assoc_addr, bool is_assoc)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
    ...
    memcpy(arg.cache_assoc.src_addr, src_addr, sizeof(yoc_bd_addr_t));
    memcpy(arg.cache_assoc.assoc_addr, assoc_addr, sizeof(yoc_bd_addr_t));

    return (btc_transfer_context(&msg, &arg, sizeof(btc_ble_gattc_args_t), NULL) == BT_STATUS_SUCCESS ? BT_OK : BT_FAIL);
}

bt_err_t yoc_ble_gattc_cache_get_addr_list(yoc_gatt_if_t gattc_if)
{
    btc_msg_t msg;
    btc_ble_gattc_args_t arg;
