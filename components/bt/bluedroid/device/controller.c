...
static void start_up(void)
{
    ...
    BT_LOG_DEBUG("controller start up");
    ...
    BT_LOG_DEBUG("controller make_reset complete");
#if (CONFIG_BT_CLASSIC_ENABLED == TRUE)
    ...
    BT_LOG_DEBUG("controller read buffer size complete");
#endif
