...
#define RETRY_LIMIT_REACHED_BIT (1 << 16)
    ...
    if ((bl_txst.value & RETRY_LIMIT_REACHED_BIT)  && (txhdr->retry_num < PACKET_RETRY_LIMIT)) {
        txhdr->retry_num ++;
#if 0
