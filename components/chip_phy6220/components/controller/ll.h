...
#define LL_STATUS_ERROR_RL_TABLE_FULL                  0x07 // Memory Capacity Exceeded, add by HZF
...
llStatus_t LL_SetPrdAdvRecvEnable(uint16 sync_handle, uint8 enable);
...
extern uint32_t  g_smartWindowLater          ;
extern uint32_t  g_smartWindowSize           ;
extern uint32_t  g_smartWindowSizeNew        ;           // to omit
extern bool      g_smartWindowActive         ;
extern uint32_t  g_smartWindowActiveCnt      ;
extern uint32_t  g_smartWindowPreAnchPoint   ;
extern uint8_t   g_smartWindowRTOCnt         ;
extern volatile uint32  g_getPn23_cnt;
extern volatile uint32  g_getPn23_seed;
...
extern uint32   g_interAuxPduDuration ;              // aux PUD duration: PDU + IFS
...
perStatsByChan_t          *p_perStatsByChan;
