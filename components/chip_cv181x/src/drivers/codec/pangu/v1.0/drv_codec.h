 ...
 * @model    codec
 ******************************************************************************/
#ifndef _DRV_CODEC_V1_H_
#define _DRV_CODEC_V1_H_
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_set_digital_gain(codec_input_t *handle, int32_t val);
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_set_analog_gain(codec_input_t *handle, int32_t val);
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_get_digital_gain(codec_input_t *handle, int32_t *val);
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_get_analog_gain(codec_input_t *handle, int32_t *val);
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_set_mixer_gain(codec_input_t *handle, int32_t val);
...
/**
  ...
  \return 0 for success, negative for error code
*/
int32_t codec_input_get_mixer_gain(codec_input_t *handle, int32_t *val);
