...
typedef struct
{
  ...
  __IO uint32_t HCDMAB;           /*!< Host Channel DMA Address Register        51Ch */
...
#define USB_OTG_GUSBCFG_UTMI_SEL
...
/********************  Bit definition for USB_OTG_GDFIFOCFG) register  ********************/
#define USB_OTG_GDFIFOCFG_EPINFOBASE_MASK	(0xffff << 16)
#define USB_OTG_GDFIFOCFG_EPINFOBASE_SHIFT	16
#define USB_OTG_GDFIFOCFG_GDFIFOCFG_MASK	(0xffff << 0)
#define USB_OTG_GDFIFOCFG_GDFIFOCFG_SHIFT	0
...
#define USB_OTG_HCCHAR_EPDIR_IN                  (0x1UL << USB_OTG_HCCHAR_EPDIR_Pos) /*!< 0x00008000 */
