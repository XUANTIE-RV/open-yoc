...
/******************************************************************************
 * @file     wj_i2s_ll.h
 * @brief    header file for wj i2s v2 ll driver
 * @version  V1.0
 * @date     23. Feb 2020
 ******************************************************************************/

#ifndef _WJ_I2S_LL_H_
#define _WJ_I2S_LL_H_
...
static inline void wj_i2s_set_transmit_mode(wj_i2s_regs_t *i2s_base, uint32_t en)
{
    uint32_t val = i2s_base->I2S_FUNCMODE;

    val |= WJ_FUNCMODE_CH0_ENABLE;
...
static inline void wj_i2s_set_receive_mode(wj_i2s_regs_t *i2s_base, uint32_t en)
{
    uint32_t val = i2s_base->I2S_FUNCMODE;
...
static inline void wj_i2s_set_full_duplex_mode(wj_i2s_regs_t *i2s_base, uint32_t en)
{
    uint32_t val = i2s_base->I2S_FUNCMODE;
...
static inline void wj_i2s_set_receive_no_delay(wj_i2s_regs_t *i2s_base, uint32_t delay)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_I2S_RDELAY_Msk;
}

static inline void wj_i2s_set_receive_1_cycle_delay(wj_i2s_regs_t *i2s_base, uint32_t delay)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_I2S_RDELAY_Msk;
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_I2S_RDELAY_1_DELAY;
}

static inline void wj_i2s_set_receive_2_cycle_delay(wj_i2s_regs_t *i2s_base, uint32_t delay)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_I2S_RDELAY_Msk;
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_I2S_RDELAY_2_DELAY;
}

static inline void wj_i2s_set_receive_3_cycle_delay(wj_i2s_regs_t *i2s_base, uint32_t delay)
{
...
static inline void wj_i2s_receive_mode_slave_sclk_src_clk(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_I2S_RX_CLK_SEL_MCLK;
}

static inline void wj_i2s_receive_mode_slave_sclk_mclk_i(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_I2S_RX_CLK_SEL_MCLK;
}

static inline void wj_i2s_receive_mode_source_is_single_channel(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_RVOICEEN_MONO;
}

static inline void wj_i2s_receive_mode_source_is_dual_channel(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_RVOICEEN_MONO;
}

static inline void wj_i2s_receive_mode_right_channel(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_RX_CH_SEL_LEFT;
}

static inline void wj_i2s_receive_mode_left_channel(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_RX_CH_SEL_LEFT;
}
...
static inline void wj_i2s_receive_mode_format_pcm(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_IN &= ~WJ_IISCNFIN_RSAFS_Msk;
    i2s_base->I2S_IISCNF_IN |= WJ_IISCNFIN_RSAFS_PCM;
}

static inline void wj_i2s_receive_mode_mclk_sel_256_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_MCLK_SEL_384;
}

static inline void wj_i2s_receive_mode_mclk_sel_384_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA |= WJ_FSSTA_MCLK_SEL_384;
}

static inline void wj_i2s_receive_mode_sclk_sel_32_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_SCLK_SEL_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_SCLK_SEL_32;
}

static inline void wj_i2s_receive_mode_sclk_sel_48_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_SCLK_SEL_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_SCLK_SEL_48;
}

static inline void wj_i2s_receive_mode_sclk_sel_64_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_SCLK_SEL_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_SCLK_SEL_64;
}

static inline void wj_i2s_receive_mode_sclk_sel_16_fs(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_SCLK_SEL_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_SCLK_SEL_16;
}

static inline void wj_i2s_data_width_mode(wj_i2s_regs_t *i2s_base, uint32_t mode)
{
...
static inline void wj_i2s_receive_mode_audio_rate_scale_factor_0_125(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_ARS_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_ARS_0_125;
}

static inline void wj_i2s_receive_mode_audio_fundamental_rate_88_2k(wj_i2s_regs_t *i2s_base)
{
...
static inline void wj_i2s_receive_mode_audio_fundamental_rate_64k(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_AFR_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_AFR_64KSPS;
}

static inline void wj_i2s_receive_mode_audio_fundamental_rate_192k(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_FSSTA &= ~WJ_FSSTA_AFR_Msk;
    i2s_base->I2S_FSSTA |= WJ_FSSTA_AFR_192KSPS;
}

static inline void wj_i2s_receive_mode_audio_input_rate_no_detected(wj_i2s_regs_t *i2s_base)
{
...
static inline void wj_i2s_transmit_mode_format_pcm(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_OUT &= ~WJ_IISCNFOUT_TSAFS_Msk;
...
static inline void wj_i2s_transmit_mode_slave_sclk_src_clk(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_OUT &= ~WJ_IISCNFOUT_TX_CLK_SEL_MCLK;
}

static inline void wj_i2s_transmit_mode_slave_sclk_mclk_i(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_IISCNF_OUT |= WJ_IISCNFOUT_TX_CLK_SEL_MCLK;
}
...
static inline void wj_i2s_88_2k_fs_threshold(wj_i2s_regs_t *i2s_base, uint32_t level)
{
    i2s_base->I2S_FADTLR |= level << WJ_FADTLR_88FTR_Pos;
}

static inline void wj_i2s_64k_fs_threshold(wj_i2s_regs_t *i2s_base, uint32_t level)
{
    i2s_base->I2S_FADTLR |= level << WJ_FADTLR_64FTR_Pos;
}

static inline void wj_i2s_192k_fs_threshold(wj_i2s_regs_t *i2s_base, uint32_t level)
{
...
static inline void wj_i2s_set_transmit_fifo_level(wj_i2s_regs_t *i2s_base, uint32_t level)
{
    i2s_base->I2S_TXFTLR &= ~WJ_TXFTLR_TFT_Msk;
    i2s_base->I2S_TXFTLR = level << WJ_TXFTLR_TFT_Pos;
}

static inline void wj_i2s_set_receive_fifo_level(wj_i2s_regs_t *i2s_base, uint32_t level)
{
...
{
    return (uint32_t)i2s_base->I2S_TXFLR;
}

static inline uint32_t wj_i2s_get_receive_fifo_level(wj_i2s_regs_t *i2s_base)
{
    return (uint32_t)i2s_base->I2S_RXFLR;
}

static inline uint32_t wj_i2s_get_i2s_status(wj_i2s_regs_t *i2s_base)
{
    return (uint32_t)i2s_base->I2S_SR;
}

static inline uint32_t wj_i2s_get_i2s_irq_status(wj_i2s_regs_t *i2s_base)
{
    return i2s_base->I2S_ISR;
}

static inline uint32_t wj_i2s_get_i2s_irq_raw_status(wj_i2s_regs_t *i2s_base)
{
    return i2s_base->I2S_RISR;
}

static inline void wj_i2s_set_irq(wj_i2s_regs_t *i2s_base, uint32_t val)
{
    i2s_base->I2S_IMR = val;
}

static inline void wj_i2s_clear_irq(wj_i2s_regs_t *i2s_base, uint32_t val)
{
    i2s_base->I2S_ICR = val;
}
...
static inline void wj_i2s_set_receive_dma_disable(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_DMACR &= ~WJ_DMACR_RDMAE_EN;
}
...
static inline void wj_i2s_set_transmit_dma_disable(wj_i2s_regs_t *i2s_base)
{
    i2s_base->I2S_DMACR &= ~WJ_DMACR_TDMAE_EN;
}
...
static inline void wj_i2s_set_div_sclk(wj_i2s_regs_t *i2s_base, uint32_t div)
{
    i2s_base->I2S_DIV0_LEVEL = div;
}

static inline void wj_i2s_set_div_ref_clk(wj_i2s_regs_t *i2s_base, uint32_t div)
{
