...
void __DMA_Channel0_IRQHandler(void)
{
    dma_irq_proc((void *)0);
}
void __DMA_Channel1_IRQHandler(void)
{
    dma_irq_proc((void *)1);
}
void __DMA_Channel2_IRQHandler(void)
{
    dma_irq_proc((void *)2);
}
void __DMA_Channel3_IRQHandler(void)
{
    dma_irq_proc((void *)3);
}
void __DMA_Channel4_7_IRQHandler(void)
{
    dma_irq_proc((void *)4);
}
