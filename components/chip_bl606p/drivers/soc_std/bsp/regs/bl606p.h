...
#define CPU_LP_MAX_IRQ_NUM (IRQ_NUM_BASE + 32)
    ...
    RESERVED0_IRQn = IRQ_NUM_BASE + 1,        /*!< Reserved Interrupt                                                */
    ...
    RESERVED1_IRQn = IRQ_NUM_BASE + 8,        /*!< Reserved Interrupt                                                */
    RESERVED2_IRQn = IRQ_NUM_BASE + 9,        /*!< Reserved Interrupt                                                */
    RESERVED3_IRQn = IRQ_NUM_BASE + 10,       /*!< Reserved Interrupt                                                */
    RESERVED4_IRQn = IRQ_NUM_BASE + 11,       /*!< Reserved Interrupt                                                */
    RESERVED5_IRQn = IRQ_NUM_BASE + 12,       /*!< Reserved Interrupt                                                */
    RESERVED6_IRQn = IRQ_NUM_BASE + 13,       /*!< Reserved Interrupt                                                */
    RESERVED7_IRQn = IRQ_NUM_BASE + 14,       /*!< Reserved Interrupt                                                */
    RESERVED8_IRQn = IRQ_NUM_BASE + 15,       /*!< Reserved Interrupt                                                */
    RESERVED9_IRQn = IRQ_NUM_BASE + 16,       /*!< Reserved Interrupt                                                */
    RESERVED10_IRQn = IRQ_NUM_BASE + 17,      /*!< Reserved Interrupt                                                */
    RESERVED11_IRQn = IRQ_NUM_BASE + 18,      /*!< Reserved Interrupt                                                */
    RESERVED12_IRQn = IRQ_NUM_BASE + 19,      /*!< Reserved Interrupt                                                */
    RESERVED13_IRQn = IRQ_NUM_BASE + 20,      /*!< Reserved Interrupt                                                */
    RESERVED14_IRQn = IRQ_NUM_BASE + 21,      /*!< Reserved Interrupt                                                */
    RESERVED15_IRQn = IRQ_NUM_BASE + 22,      /*!< Reserved Interrupt                                                */
    RESERVED16_IRQn = IRQ_NUM_BASE + 23,      /*!< Reserved Interrupt                                                */
    ...
    RESERVED17_IRQn = IRQ_NUM_BASE + 37,      /*!< Reserved Interrupt                                                */
    IPC_D0_IRQn = IRQ_NUM_BASE + 38,          /*!< IPC D0 Interrupt                                                  */
    APU_IRQn = IRQ_NUM_BASE + 39,             /*!< APU Interrupt                                                     */
    RESERVED18_IRQn = IRQ_NUM_BASE + 40,      /*!< Reserved Interrupt                                                */
    RESERVED19_IRQn = IRQ_NUM_BASE + 41,      /*!< Reserved Interrupt                                                */
    RESERVED20_IRQn = IRQ_NUM_BASE + 42,      /*!< Reserved Interrupt                                                */
    RESERVED21_IRQn = IRQ_NUM_BASE + 43,      /*!< Reserved Interrupt                                                */
    RESERVED22_IRQn = IRQ_NUM_BASE + 44,      /*!< Reserved Interrupt                                                */
    RESERVED23_IRQn = IRQ_NUM_BASE + 45,      /*!< Reserved Interrupt                                                */
    RESERVED24_IRQn = IRQ_NUM_BASE + 46,      /*!< Reserved Interrupt                                                */
    RESERVED25_IRQn = IRQ_NUM_BASE + 47,      /*!< Reserved Interrupt                                                */
    PWM_IRQn = IRQ_NUM_BASE + 48,             /*!< PWM1 Interrupt                                                    */
    RESERVED26_IRQn = IRQ_NUM_BASE + 49,      /*!< Reserved Interrupt                                                */
    RESERVED27_IRQn = IRQ_NUM_BASE + 50,      /*!< Reserved Interrupt                                                */
    RESERVED28_IRQn = IRQ_NUM_BASE + 51,      /*!< Reserved Interrupt                                                */
    RESERVED29_IRQn = IRQ_NUM_BASE + 52,      /*!< Reserved Interrupt                                                */
    RESERVED30_IRQn = IRQ_NUM_BASE + 53,      /*!< Reserved Interrupt                                                */
    RESERVED31_IRQn = IRQ_NUM_BASE + 54,      /*!< Reserved Interrupt                                                */
    RESERVED32_IRQn = IRQ_NUM_BASE + 55,      /*!< Reserved Interrupt                                                */
    RESERVED33_IRQn = IRQ_NUM_BASE + 56,      /*!< Reserved Interrupt                                                */
    RESERVED34_IRQn = IRQ_NUM_BASE + 57,      /*!< Reserved Interrupt                                                */
    RESERVED35_IRQn = IRQ_NUM_BASE + 58,      /*!< Reserved Interrupt                                                */
    RESERVED36_IRQn = IRQ_NUM_BASE + 59,      /*!< Reserved Interrupt                                                */
    RESERVED37_IRQn = IRQ_NUM_BASE + 60,      /*!< Reserved Interrupt                                                */
...
/**
 * @brief BL606P Memory Map Definitions
 */
#define BL606P_OCRAM_BASE                   (0x22020000)
#define BL606P_OCRAM_END                    (0x22020000 + 64 * 1024)
#define BL606P_OCRAM_CACHEABLE_BASE         (0x62020000)
#define BL606P_OCRAM_CACHEABLE_END          (0x62020000 + 64 * 1024)

#define BL606P_WRAM_BASE                    (0x22030000)
#define BL606P_WRAM_END                     (0x22030000 + 160 * 1024)
#define BL606P_WRAM_CACHEABLE_BASE          (0x62030000)
#define BL606P_WRAM_CACHEABLE_END           (0x62030000 + 160 * 1024)

#define BL606P_MCU_ALLRAM_BASE              (0x22020000)
#define BL606P_MCU_ALLRAM_END               (0x22020000 + 64 * 1024 + 160 * 1024)
#define BL606P_MCU_ALLRAM_CACHEABLE_BASE    (0x62020000)
#define BL606P_MCU_ALLRAM_CACHEABLE_END     (0x62020000 + 64 * 1024 + 160 * 1024)

#define BL606P_DRAM_BASE                    (0x3EF80000)
#define BL606P_DRAM_END                     (0x3EF80000 + 512 * 1024)
#define BL606P_DRAM_CACHEABLE_BASE          (0x7EF80000)
#define BL606P_DRAM_CACHEABLE_END           (0x7EF80000 + 512 * 1024)

#define BL606P_VRAM_BASE                    (0x3F000000)
#define BL606P_VRAM_END                     (0x3F000000 + 32 * 1024)
#define BL606P_VRAM_CACHEABLE_BASE          (0x7F000000)
#define BL606P_VRAM_CACHEABLE_END           (0x7F000000 + 32 * 1024)

#define BL606P_DSP_ALLRAM_BASE              (0x3EF80000)
#define BL606P_DSP_ALLRAM_END               (0x3EF80000 + 512 * 1024 + 32 * 1024)
#define BL606P_DSP_ALLRAM_CACHEABLE_BASE    (0x7EF80000)
#define BL606P_DSP_ALLRAM_CACHEABLE_END     (0x7EF80000 + 512 * 1024 + 32 * 1024)

#define BL606P_FLASH_XIP_BASE               (0x58000000)
#define BL606P_FLASH_XIP_END                (0x58000000 + 64 * 1024 * 1024)
#define BL606P_FLASH2_XIP_BASE              (0x5C000000)
#define BL606P_FLASH2_XIP_END               (0x5C000000 + 64 * 1024 * 1024)
#define BL606P_FLASH_XIP_REMAP0_BASE        (0xD8000000)
#define BL606P_FLASH_XIP_REMAP0_END         (0xD8000000 + 64 * 1024 * 1024)
#define BL606P_FLASH2_XIP_REMAP0_BASE       (0xDC000000)
#define BL606P_FLASH2_XIP_REMAP0_END        (0xDC000000 + 64 * 1024 * 1024)

#define BL606P_DSP_WHOLERAM_BASE                (0x3EF80000)
#define BL606P_DSP_WHOLERAM_END                 (0x3EF80000 + 512 * 1024 + 96 * 1024)
#define BL606P_DSP_WHOLERAM_CACHEABLE_BASE      (0x7EF80000)
#define BL606P_DSP_WHOLERAM_CACHEABLE_END       (0x7EF80000 + 512 * 1024 + 96 * 1024)

/*@} end of group Memory_Map_Section */

/* BL606P peripherals base address */
/* WLSYS */
...
typedef enum {
    ...
    BL_AHB_SLAVE1_RSVD32 = 0x24, /* not used for cgen and swrst */
} BL_AHB_Slave1_Type;
