                                    ...
                                    size_t buflen )
{
    ...
    /* cert_exist = 1 means this cert has store in flash ,no need verify*/
    /* TODO, skip verify if cert_exist = 1*/
    unsigned char cert_exist = 0;
    crt->raw.p = p = ck_cert_store(buf, crt->raw.len, &cert_exist);
...
#endif /*CK_REMOVE_UNUSED_FUNCTION_AND_DATA*/
