                 ...
                 DBusError        *error)
{
  ...
  context->limits.max_incoming_bytes             = 133169152;
  context->limits.max_incoming_unix_fds          = 64;
  context->limits.max_outgoing_bytes             = 133169152;
  context->limits.max_outgoing_unix_fds          = 64;
  context->limits.max_message_size               = 33554432;
  context->limits.max_message_unix_fds           = 16;
  context->limits.activation_timeout             = 25000;
  context->limits.auth_timeout                   = 30000;
  context->limits.pending_fd_timeout             = 150000;
  context->limits.max_completed_connections      = 2048;
  context->limits.max_incomplete_connections     = 64;
  context->limits.max_connections_per_user       = 256;
  context->limits.max_pending_activations        = 512;
  context->limits.max_services_per_connection    = 512;
  context->limits.max_match_rules_per_connection = 512;
  context->limits.max_replies_per_connection     = 128;
  context->limits.reply_timeout                  = -1;
#endif
