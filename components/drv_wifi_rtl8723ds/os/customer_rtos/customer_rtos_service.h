...
#define xTaskGetTickCount aos_now_ms
#define vTaskDelay aos_msleep
#define vTaskDelete aos_task_exit
static inline int xPortGetFreeHeapSize()
{
    return 0;
}
...
#if WLAN_INTF_DBG
#define DBG_TRACE(fmt, args...)		rtw_printf("\n\r[%s] " fmt, __FUNCTION__, ## args)
#define DBG_INFO(fmt, args...)		rtw_printf("\n\r[%s] " fmt, __FUNCTION__, ## args)
#else
