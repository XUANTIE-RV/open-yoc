...
extern int rltk_get_snr(unsigned char *ofdm_snr, unsigned char *ht_snr);

extern int rltk_get_rate(unsigned char *prate, unsigned char *pshort_gi, unsigned char *pbandwidth);
...
#else
    #define RTW_API_INFO rtw_printf
#endif
#else
    #define RTW_API_INFO(...)
#endif
...
/**
  * @brief Wait auto reconnect thread exit
*/
