...
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_SCAN_START\n", __func__);
#endif
			break;
		case WIFI_EVENT_SCAN_FAILED:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_SCAN_FAILED\n", __func__);
#endif
			break;
		case WIFI_EVENT_AUTHENTICATION:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_AUTHENTICATION\n", __func__);
#endif
			break;
		case WIFI_EVENT_AUTH_REJECT:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_AUTH_REJECT\n", __func__);
#endif
			break;
		case WIFI_EVENT_DEAUTH:
#if(WIFI_INDICATE_MSG==1)
					printf("\n\r%s(): WIFI_EVENT_DEAUTH\n", __func__);
#endif
			break;

		case WIFI_EVENT_AUTH_TIMEOUT:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_AUTH_TIMEOUT\n", __func__);
#endif
			break;
...
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_ASSOCIATED\n", __func__);
#endif
			break;
		case WIFI_EVENT_ASSOC_REJECT:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_ASSOC_REJECT\n", __func__);
#endif
			break;
		case WIFI_EVENT_ASSOC_TIMEOUT:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_ASSOC_TIMEOUT\n", __func__);
#endif
			break;

		case WIFI_EVENT_HANDSHAKE_FAILED:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_HANDSHAKE_FAILED\n", __func__);
#endif
			break;
		case WIFI_EVENT_4WAY_HANDSHAKE:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_4WAY_HANDSHAKE\n", __func__);
#endif
			break;
		case WIFI_EVENT_GROUP_HANDSHAKE:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_GROUP_HANDSHAKE\n", __func__);
#endif
			break;
		case WIFI_EVENT_GROUP_HANDSHAKE_DONE:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_GROUP_HANDSHAKE_DONE\n", __func__);
#endif
			break;
		case WIFI_EVENT_CONN_TIMEOUT:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_CONN_TIMEOUT\n", __func__);
#endif
			break;
		case WIFI_EVENT_LEAVE_BUSY_TRAFFIC:
#if(WIFI_INDICATE_MSG==1)
			printf("\n\r%s(): WIFI_EVENT_LEAVE_BUSY_TRAFFIC\n", __func__);
#endif
			break;			
	}
