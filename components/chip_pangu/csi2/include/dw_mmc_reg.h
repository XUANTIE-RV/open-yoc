...
typedef struct {
    ...
    volatile uint32_t PWREN;                             /**< Power Enable register, offset: 0x4 */
    volatile uint32_t CLKDIV;                            /**< Clock Divider register, offset: 0x8 */
    uint8_t RESERVED_0[4];
    volatile uint32_t CLKENA;                            /**< Clock Enable register, offset: 0x10 */
    volatile uint32_t TMOUT;                             /**< Time-out register, offset: 0x14 */
    volatile uint32_t CTYPE;                             /**< Card Type register, offset: 0x18 */
    volatile uint32_t BLKSIZ;                            /**< Block Size register, offset: 0x1C */
    volatile uint32_t BYTCNT;                            /**< Byte Count register, offset: 0x20 */
    volatile uint32_t INTMASK;                           /**< Interrupt Mask register, offset: 0x24 */
    volatile uint32_t CMDARG;                            /**< Command Argument register, offset: 0x28 */
    volatile uint32_t CMD;                               /**< Command register, offset: 0x2C */
    volatile uint32_t RESP[4];                           /**< Response register, array offset: 0x30, array step: 0x4 */
    volatile uint32_t MINTSTS;                           /**< Masked Interrupt Status register, offset: 0x40 */
    volatile uint32_t RINTSTS;                           /**< Raw Interrupt Status register, offset: 0x44 */
    volatile uint32_t STATUS;                            /**< Status register, offset: 0x48 */
    volatile uint32_t FIFOTH;                            /**< FIFO Threshold Watermark register, offset: 0x4C */
    volatile uint32_t CDETECT;                           /**< Card Detect register, offset: 0x50 */
    volatile uint32_t WRTPRT;                            /**< Write Protect register, offset: 0x54 */
    uint8_t RESERVED_1[4];
    volatile uint32_t TCBCNT;                            /**< Transferred CIU Card Byte Count register, offset: 0x5C */
    volatile uint32_t TBBCNT;                            /**< Transferred Host to BIU-FIFO Byte Count register, offset: 0x60 */
    volatile uint32_t DEBNCE;                            /**< Debounce Count register, offset: 0x64 */
    uint8_t RESERVED_2[16];
    volatile uint32_t RST_N;                             /**< Hardware Reset, offset: 0x78 */
    uint8_t RESERVED_3[4];
    volatile uint32_t BMOD;                              /**< Bus Mode register, offset: 0x80 */
    volatile uint32_t PLDMND;                            /**< Poll Demand register, offset: 0x84 */
    volatile uint32_t DBADDR;                            /**< Descriptor List Base Address register, offset: 0x88 */
    volatile uint32_t IDSTS;                             /**< Internal DMAC Status register, offset: 0x8C */
    volatile uint32_t IDINTEN;                           /**< Internal DMAC Interrupt Enable register, offset: 0x90 */
    volatile uint32_t DSCADDR;                           /**< Current Host Descriptor Address register, offset: 0x94 */
    volatile uint32_t BUFADDR;                           /**< Current Buffer Descriptor Address register, offset: 0x98 */
    //    uint8_t RESERVED_4[100];
    uint32_t RESERVED_4[27];
    volatile uint32_t UHS_REG_EXT;  /* Offset: 0x108(R/W) UHS Register */
    uint32_t RESERVED_5[61];

//  volatile uint32_t CARDTHRCTL;                        /**< Card Threshold Control, offset: 0x100 */
//  volatile uint32_t BACKENDPWR;                        /**< Power control, offset: 0x104 */
