...
static int32_t i2s_send_polling(csi_i2s_t *i2s, const void *data, uint32_t num)
{
    ...
    num = num / 4U;
    wj_i2s_clear_irq(i2s_base, 0xffffu);
...
csi_error_t csi_i2s_rx_select_sound_channel(csi_i2s_t *i2s, csi_i2s_sound_channel_t ch)
{
    ...
    switch (ch) {
        case I2S_LEFT_CHANNEL:
            wj_i2s_receive_mode_source_is_single_channel(i2s_base);
            wj_i2s_receive_mode_left_channel(i2s_base);
            break;

        case I2S_RIGHT_CHANNEL:
            wj_i2s_receive_mode_source_is_single_channel(i2s_base);
            wj_i2s_receive_mode_right_channel(i2s_base);
            break;

        case I2S_LEFT_RIGHT_CHANNEL:
            wj_i2s_receive_mode_source_is_dual_channel(i2s_base);
            break;
