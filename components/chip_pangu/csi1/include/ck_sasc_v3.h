...
#define EFLASH_ADDR_END     0x1007f7ff
...
#define SRAM0_ADDR_END       0x20007fff

#define SRAM1_ADDR_START     0x20004000
#define SRAM1_ADDR_END       0x2000ffff

#define SRAM2_ADDR_START     0x20010000
#define SRAM2_ADDR_END       0x2001ffff

#define SRAM3_ADDR_START     0x14000000
#define SRAM3_ADDR_END       0x1400ffff
