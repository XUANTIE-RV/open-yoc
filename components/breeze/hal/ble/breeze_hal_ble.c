 ...
 */
#if (defined CONFIG_WIFI_PROV_BLE_BLUEDROID) && CONFIG_WIFI_PROV_BLE_BLUEDROID
...
static int read_ais_rc(void *buf, uint16_t len, uint16_t offset)
{
    int ret = 0;
...
static int read_ais_wc(void *buf, uint16_t len, uint16_t offset)
{
    int ret = 0;
    printf("%s length to read: %d, offset: %d\r\n", __func__, len, offset);
...
static int read_ais_ic(void *buf, uint16_t len, uint16_t offset)
{
    int ret = 0;
    printf("%s length to read: %d, offset: %d\r\n", __func__, len, offset);
...
static int read_ais_wwnrc(void *buf, uint16_t len, uint16_t offset)
{
    int ret = 0;
    printf("%s length to read: %d, offset: %d\r\n", __func__, len, offset);
...
static int write_ais_wwnrc(void *buf, uint16_t len, uint16_t offset, uint8_t flags)
{
    int ret = 0;
...
static int read_ais_nc(void *buf, uint16_t len, uint16_t offset)
{
    int ret = 0;
    printf("%s length to read: %d, offset: %d\r\n", __func__, len, offset);
