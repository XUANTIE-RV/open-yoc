...
struct usbd_rndis_cfg_priv {
    ...
    uint8_t mac[6];
                     ...
                     .link_status = USB_RNDIS_MEDIA_STATE_DISCONNECTED,
...
static volatile uint8_t *g_rndis_rx_data_buffer;
static volatile uint32_t g_rndis_rx_data_length;
static volatile uint32_t g_rndis_tx_data_length;
static rndis_read_cb g_read_cb;

/* RNDIS options list */
const uint32_t oid_supported_list[] = {
    /* General OIDs */
    USB_RNDIS_OID_GEN_SUPPORTED_LIST,
    USB_RNDIS_OID_GEN_HARDWARE_STATUS,
    USB_RNDIS_OID_GEN_MEDIA_SUPPORTED,
    USB_RNDIS_OID_GEN_MEDIA_IN_USE,
    USB_RNDIS_OID_GEN_MAXIMUM_FRAME_SIZE,
    USB_RNDIS_OID_GEN_LINK_SPEED,
    USB_RNDIS_OID_GEN_TRANSMIT_BLOCK_SIZE,
    USB_RNDIS_OID_GEN_RECEIVE_BLOCK_SIZE,
    USB_RNDIS_OID_GEN_VENDOR_ID,
    USB_RNDIS_OID_GEN_VENDOR_DESCRIPTION,
    USB_RNDIS_OID_GEN_VENDOR_DRIVER_VERSION,
    USB_RNDIS_OID_GEN_CURRENT_PACKET_FILTER,
    USB_RNDIS_OID_GEN_MAXIMUM_TOTAL_SIZE,
    USB_RNDIS_OID_GEN_MEDIA_CONNECT_STATUS,

    USB_RNDIS_OID_GEN_PHYSICAL_MEDIUM,

    /* General Statistic OIDs */
    USB_RNDIS_OID_GEN_XMIT_OK,
    USB_RNDIS_OID_GEN_RCV_OK,
    USB_RNDIS_OID_GEN_XMIT_ERROR,
    USB_RNDIS_OID_GEN_RCV_ERROR,
    USB_RNDIS_OID_GEN_RCV_NO_BUFFER,

    /* Please configure us */
    USB_RNDIS_OID_GEN_RNDIS_CONFIG_PARAMETER,

    /* 802.3 OIDs */
    USB_RNDIS_OID_802_3_PERMANENT_ADDRESS,
    USB_RNDIS_OID_802_3_CURRENT_ADDRESS,
    USB_RNDIS_OID_802_3_MULTICAST_LIST,
    USB_RNDIS_OID_802_3_MAXIMUM_LIST_SIZE,

    /* 802.3 Statistic OIDs */
    USB_RNDIS_OID_802_3_RCV_ERROR_ALIGNMENT,
    USB_RNDIS_OID_802_3_XMIT_ONE_COLLISION,
    USB_RNDIS_OID_802_3_XMIT_MORE_COLLISIONS,

    USB_RNDIS_OID_802_3_MAC_OPTIONS,
};
...
static int rndis_query_cmd_handler(uint8_t *data, uint32_t len)
{
    ...
    switch (cmd->Oid) {
        case USB_RNDIS_OID_GEN_SUPPORTED_LIST:
            RNDIS_INQUIRY_PUT(oid_supported_list, sizeof(oid_supported_list));
            infomation_len = sizeof(oid_supported_list);
            break;
        case USB_RNDIS_OID_GEN_HARDWARE_STATUS:
            RNDIS_INQUIRY_PUT_LE32(USB_RNDIS_HW_STS_READY);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_MEDIA_SUPPORTED:
        case USB_RNDIS_OID_GEN_MEDIA_IN_USE:
            RNDIS_INQUIRY_PUT_LE32(USB_RNDIS_MEDIUM_802_3);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_MAXIMUM_FRAME_SIZE:
        case USB_RNDIS_OID_GEN_TRANSMIT_BLOCK_SIZE:
        case USB_RNDIS_OID_GEN_RECEIVE_BLOCK_SIZE:
            RNDIS_INQUIRY_PUT_LE32(CONFIG_USBDEV_RNDIS_ETH_MAX_FRAME_SIZE);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_VENDOR_ID:
            RNDIS_INQUIRY_PUT_LE32(CONFIG_USBDEV_RNDIS_VENDOR_ID);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_VENDOR_DRIVER_VERSION:
            RNDIS_INQUIRY_PUT_LE32(0x0001);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_VENDOR_DESCRIPTION:
            ...
            break;
        case USB_RNDIS_OID_802_3_CURRENT_ADDRESS:
        case USB_RNDIS_OID_802_3_PERMANENT_ADDRESS:
            RNDIS_INQUIRY_PUT(usbd_rndis_cfg.mac, 6);
            infomation_len = 6;
            break;
        case USB_RNDIS_OID_GEN_PHYSICAL_MEDIUM:
            RNDIS_INQUIRY_PUT_LE32(USB_RNDIS_MEDIUM_802_3);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_LINK_SPEED:
        ...
        case USB_RNDIS_OID_GEN_RNDIS_CONFIG_PARAMETER:
            ...
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_MAXIMUM_LIST_SIZE:
            RNDIS_INQUIRY_PUT_LE32(1); /* one address */
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_MULTICAST_LIST:
            //RNDIS_INQUIRY_PUT_LE32(0xE0000000); /* 224.0.0.0 */
            resp->Status = RNDIS_STATUS_NOT_SUPPORTED;
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_MAC_OPTIONS:
            // infomation_len = 0;
            resp->Status = RNDIS_STATUS_NOT_SUPPORTED;
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_MAC_OPTIONS:
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_RCV_ERROR_ALIGNMENT:
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_XMIT_ONE_COLLISION:
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_802_3_XMIT_MORE_COLLISIONS:
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_XMIT_OK:
            RNDIS_INQUIRY_PUT_LE32(usbd_rndis_cfg.eth_state.txok);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_RCV_OK:
            RNDIS_INQUIRY_PUT_LE32(usbd_rndis_cfg.eth_state.rxok);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_RCV_ERROR:
            RNDIS_INQUIRY_PUT_LE32(usbd_rndis_cfg.eth_state.rxbad);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_XMIT_ERROR:
            RNDIS_INQUIRY_PUT_LE32(usbd_rndis_cfg.eth_state.txbad);
            infomation_len = 4;
            break;
        case USB_RNDIS_OID_GEN_RCV_NO_BUFFER:
            RNDIS_INQUIRY_PUT_LE32(0);
            infomation_len = 4;
            break;
        default:
...
static int rndis_set_cmd_handler(uint8_t *data, uint32_t len)
{
    ...
    switch (cmd->Oid) {
        ...
        case USB_RNDIS_OID_GEN_CURRENT_PACKET_FILTER:
            ...
            break;
        case USB_RNDIS_OID_GEN_CURRENT_LOOKAHEAD:
            break;
        case USB_RNDIS_OID_GEN_PROTOCOL_OPTIONS:
            break;
        case USB_RNDIS_OID_802_3_MULTICAST_LIST:
            break;
        case USB_RNDIS_OID_PNP_ADD_WAKE_UP_PATTERN:
        case USB_RNDIS_OID_PNP_REMOVE_WAKE_UP_PATTERN:
        case USB_RNDIS_OID_PNP_ENABLE_WAKE_UP:
        default:
            resp->Status = RNDIS_STATUS_FAILURE;
            USB_LOG_WRN("Unhandled query for Object ID 0x%x\r\n", cmd->Oid);
            break;
...
static void rndis_notify_handler(uint8_t event, void *arg)
{
    switch (event) {
        case USBD_EVENT_RESET:
            usbd_rndis_cfg.link_status = USB_RNDIS_MEDIA_STATE_DISCONNECTED;
            break;
        case USBD_EVENT_CONFIGURED:
            g_rndis_rx_data_length = 0;
            g_rndis_tx_data_length = 0;
            usbd_rndis_cfg.link_status = USB_RNDIS_MEDIA_STATE_CONNECTED;
...
void rndis_bulk_out(uint8_t ep, uint32_t nbytes)
{
    ...
    if ((hdr->MessageType != USB_RNDIS_PACKET_TYPE_DIRECTED) || (nbytes != hdr->MessageLength)) {
        usbd_ep_start_read(rndis_ep_data[RNDIS_OUT_EP_IDX].ep_addr, g_rndis_rx_buffer, sizeof(g_rndis_rx_buffer));
        return;
    }
    ...
    if (g_read_cb) {
        g_read_cb((uint8_t *)g_rndis_rx_data_buffer, g_rndis_rx_data_length);
    }
}
...
void usbd_rndis_set_read_cb(rndis_read_cb cb)
{
    g_read_cb = cb;
}
