...
{
    lwm2m_object_t *secu = (lwm2m_object_t *)LWM2M_LIST_FIND(objectP, 0);

    if (secu == NULL) {
        return NULL;
    }

    security_instance_t *targetP = (security_instance_t *)LWM2M_LIST_FIND(secu->instanceList, secObjInstID);
