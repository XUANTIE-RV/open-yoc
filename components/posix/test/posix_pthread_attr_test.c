...
void posix_pthread_attr_setstackaddr_case(void)
{
    ...
    pthread_attr_setstackaddr(&attr, (void*)0x12345678);

    if (attr.stackaddr == (void*)0x12345678) {
        flag = 1;
    } else {
        flag = 0;
    }
...
void posix_pthread_attr_getstackaddr_case(void)
{
    ...
    attr.stackaddr = (void*)0x12345678;
    pthread_attr_getstackaddr(&attr, &stackaddr);

    if (stackaddr == (void*)0x12345678) {
        flag = 1;
    } else {
        flag = 0;
    }
...
void posix_pthread_attr_setstack_case(void)
{
    ...
    pthread_attr_setstack(&attr, (void*)0x12345678, 1024);
    if ((attr.stackaddr == (void*)0x12345678) && (attr.stacksize == 1024)) {
        flag = 1;
    } else {
        flag = 0;
    }
...
void posix_pthread_attr_getstack_case(void)
{
    ...
    if ((stackaddr == (void*)0x12345678) && (stacksize = 1024)) {
        flag = 1;
    } else {
        flag = 0;
    }
