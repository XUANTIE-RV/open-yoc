...
static void *demo_task3(void *arg)
{
    ...
    if ((ret != 0)
        ||(((ktask_t*)thread1)->sched_policy != KSCHED_FIFO)
        ||(((ktask_t*)thread1)->prio != PRI_CONVERT_PX_RH(param.sched_priority))) {
    ...
    if ((ret != 0)
        ||(((ktask_t*)thread1)->sched_policy != KSCHED_RR)
        ||(((ktask_t*)thread1)->prio != PRI_CONVERT_PX_RH(param.sched_priority))
        ||(((ktask_t*)thread1)->time_slice != (param.slice * 1000) / RHINO_CONFIG_TICKS_PER_SECOND)) {
