...
#define CLOCK_REALTIME  0 /* System-wide realtime clock, can jump forwards and backwards as the system time-of-day clock is changed */
#endif
#ifndef CLOCK_MONOTONIC
#define CLOCK_MONOTONIC 1 /* The absolute elapsed wall-clock time since some arbitrary, fixed point in the past. It isn't affected by
