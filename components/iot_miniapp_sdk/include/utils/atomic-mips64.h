...
#ifndef JQUICK_UTILS_ATOMIC_MIPS64_H
#define JQUICK_UTILS_ATOMIC_MIPS64_H
...
extern JQUICK_ATOMIC_INLINE int jquick_atomic_cas(int32_t old_value, int32_t new_value, volatile int32_t* ptr)
{
    int32_t prev, status;
    do {
        __asm__ __volatile__(
...
extern JQUICK_ATOMIC_INLINE int jquick_atomic_acquire_cas(int32_t old_value,
                                                          int32_t new_value,
...
extern JQUICK_ATOMIC_INLINE int jquick_atomic_release_cas(int32_t old_value,
                                                          int32_t new_value,
                                                          volatile int32_t* ptr)
{
    jquick_memory_barrier();
...
#endif /* JQUICK_UTILS_ATOMIC_MIPS64_H */
