...
extern hciStatus_t HCI_LE_ReadLocalResolvableAddressCmd( uint8  peerIdAddrType,
                                    uint8 *peerIdAddr);
...
/*******************************************************************************
 * This LE API is used to Read transmit power
 *
 * Public function defined in hci.h.
 */
...
/*******************************************************************************
 * This LE API is used to Read RF path compensation
 *
 * Public function defined in hci.h.
 */
...
/*******************************************************************************
 * This LE API is used to write RF path compensation
 *
 * Public function defined in hci.h.
 */
...
/*******************************************************************************
 * This LE API is used to set privacy mode of peer address 
 *
 * Public function defined in hci.h.
 */
...
hciStatus_t HCI_LE_SetPrdAdvRecvEnableCmd(        uint16 sync_handle,
                                                  uint8  enable);
#ifdef __cplusplus
}
#endif
