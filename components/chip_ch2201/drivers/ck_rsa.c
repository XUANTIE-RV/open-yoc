...
*/
__WEAK rsa_handle_t csi_rsa_initialize(int32_t idx, rsa_event_cb_t cb_event)
{
...
/**
  ...
  \return      error code
*/
__WEAK int32_t csi_rsa_uninitialize(rsa_handle_t handle)
{
...
/**
  ...
  \return      error code
*/
__WEAK int32_t csi_rsa_power_control(rsa_handle_t handle, csi_power_stat_e state)
{
    RSA_NULL_PARAM_CHK(handle);
...
*/
__WEAK rsa_capabilities_t csi_rsa_get_capabilities(int32_t idx)
{
    if (idx < 0 || idx >= CONFIG_RSA_NUM) {
...
/**
  ...
  \return      error code
*/
__WEAK int32_t csi_rsa_config(rsa_handle_t handle,
...
*/
__WEAK rsa_status_t csi_rsa_get_status(rsa_handle_t handle)
{
    if (handle == NULL) {
        rsa_status_t ret;
