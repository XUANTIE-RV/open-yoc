...
#ifndef TM_CVI_H265_ENCODER_H
#define TM_CVI_H265_ENCODER_H
...
class TMH265EncoderCVI : public TMH265Encoder
{
public:
    TMH265EncoderCVI();
    virtual ~TMH265EncoderCVI();
...
private:
    ...
    virtual void InitDefaultPropertyList()
    {
        ...
        mDefaultPropertyList.Assign(TMH265Encoder::PropID::OUTPUT_GOP_NUMBER, 25);
        mDefaultPropertyList.Assign(TMH265Encoder::PropID::OUTPUT_FPS, 25);
        mDefaultPropertyList.Assign(TMH265Encoder::PropID::OUTPUT_TARGET_BITRATE, 4*1024);   //目标码率  单位kb/s
    }
};

#endif // TM_CVI_H265_ENCODER_H