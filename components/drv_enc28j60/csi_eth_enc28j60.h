...
#define ENC28J60_CSL()  enc28j60_spi_cs_status_change(0);   /* SPI_CS_LOW */

#define ENC28J60_CSH()  enc28j60_spi_cs_status_change(1);    /* SPI_CS_HIGH */
...
#define CONFIG_TCPIP_ENC28J60_USE_PBUF 1
