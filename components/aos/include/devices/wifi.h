 ...
 */
typedef struct {
    void (*sta_connect_fail)(aos_dev_t *dev, wifi_err_code_t err, void *arg);
    void (*status_change)(aos_dev_t *dev, wifi_event_id_t stat, void *arg);
    void (*scan_compeleted)(aos_dev_t *dev, uint16_t number, wifi_ap_record_t *ap_records);
    void (*fatal_err)(aos_dev_t *dev, void *arg);
} wifi_event_func;
