...
ISP_SNS_STATE_S *g_pastImx327[VI_MAX_PIPE_NUM] = {CVI_NULL};
...
#define IMX327_SENSOR_RESET_CTX(dev)         (g_pastImx327[dev] = CVI_NULL)

ISP_SNS_COMMBUS_U g_aunImx327_BusInfo[VI_MAX_PIPE_NUM] = {
	[0] = { .s8I2cDev = 0},
	[1 ... VI_MAX_PIPE_NUM - 1] = { .s8I2cDev = -1}
};

CVI_U16 g_au16Imx327_GainMode[VI_MAX_PIPE_NUM] = {0};

IMX327_STATE_S g_astImx327_State[VI_MAX_PIPE_NUM] = {{0} };
ISP_SNS_MIRRORFLIP_TYPE_E g_aeImx327_MirrorFip[VI_MAX_PIPE_NUM] = {0};
...
#define IMX327_FULL_LINES_MAX_2TO1_WDR  (0x8A)    // considering the YOUT_SIZE and bad frame
#define IMX327_VMAX_1080P30_LINEAR	1125

/*****Imx327 Register Address*****/
#define IMX327_HOLD_ADDR		0x3001
#define IMX327_SHS1_ADDR		0x3020
#define IMX327_SHS2_ADDR		0x3024
#define IMX327_GAIN_ADDR		0x3014
#define IMX327_GAIN1_ADDR		0x30F2
#define IMX327_HCG_ADDR			0x3009
#define IMX327_VMAX_ADDR		0x3018
#define IMX327_YOUT_ADDR		0x3418
#define IMX327_RHS1_ADDR		0x3030
#define IMX327_TABLE_END		0xffff
...
static CVI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
	...
	case WDR_MODE_NONE:   /*linear mode*/
		pstAeSnsDft->f32Fps = g_astImx327_mode[IMX327_MODE_1080P30].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx327_mode[IMX327_MODE_1080P30].f32MinFps;
		pstAeSnsDft->au8HistThresh[0] = 0xd;
		pstAeSnsDft->au8HistThresh[1] = 0x28;
		pstAeSnsDft->au8HistThresh[2] = 0x60;
		pstAeSnsDft->au8HistThresh[3] = 0x80;

		pstAeSnsDft->u32MaxAgain = 82281;
	...
	case WDR_MODE_2To1_LINE:
		pstAeSnsDft->f32Fps = g_astImx327_mode[IMX327_MODE_1080P30_WDR].f32MaxFps;
		pstAeSnsDft->f32MinFps = g_astImx327_mode[IMX327_MODE_1080P30_WDR].f32MinFps;
...
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	CVI_U32 u32VMAX = IMX327_VMAX_1080P30_LINEAR;
	...
	u32Vts = g_astImx327_mode[pstSnsState->u8ImgMode].u32VtsDef;
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	f32MaxFps = g_astImx327_mode[pstSnsState->u8ImgMode].f32MaxFps;
	f32MinFps = g_astImx327_mode[pstSnsState->u8ImgMode].f32MinFps;

	switch (pstSnsState->u8ImgMode) {
	case IMX327_MODE_1080P30_WDR:
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx327_State[ViPipe].u32RHS1_MAX = (u32VMAX - g_astImx327_State[ViPipe].u32BRL) * 2 - 21;
	} else {
...
static CVI_S32 cmos_inttime_update(VI_PIPE ViPipe, CVI_U32 *u32IntTime)
{
	...
	pstSnsRegsInfo = &pstSnsState->astSyncInfo[0].snsCfg;
	u16BRL = g_astImx327_mode[pstSnsState->u8ImgMode].u16BRL;
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		g_astImx327_State[ViPipe].u32RHS1 = u32RHS1;
		/* short exposure */
...
static CVI_S32 cmos_gains_update(VI_PIPE ViPipe, CVI_U32 *pu32Again, CVI_U32 *pu32Dgain)
{
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;
	ISP_SNS_REGS_INFO_S *pstSnsRegsInfo = CVI_NULL;
	CVI_U32 u32HCG = g_astImx327_State[ViPipe].u8Hcg;
	CVI_U32 u16Mode = g_au16Imx327_GainMode[ViPipe];
	CVI_U32 u32Tmp;
	CVI_U32 u32Again;
	CVI_U32 u32Dgain;
		...
		CVI_U32 *au32IntTimeMax, CVI_U32 *au32IntTimeMin, CVI_U32 *pu32LFMaxIntTime)
{
	...
	if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode) {
		...
		u32IntTimeMaxTmp  = (u32IntTimeMaxTmp > (g_astImx327_State[ViPipe].u32RHS1_MAX - 3)) ?
						(g_astImx327_State[ViPipe].u32RHS1_MAX - 3) : u32IntTimeMaxTmp;
...
static CVI_S32 cmos_get_wdr_size(VI_PIPE ViPipe, ISP_SNS_ISP_INFO_S *pstIspCfg)
{
	const IMX327_MODE_S *pstMode = CVI_NULL;
	ISP_SNS_STATE_S *pstSnsState = CVI_NULL;

	IMX327_SENSOR_GET_CTX(ViPipe, pstSnsState);
	CMOS_CHECK_POINTER(pstSnsState);
	pstMode = &g_astImx327_mode[pstSnsState->u8ImgMode];
...
static CVI_S32 cmos_set_wdr_mode(VI_PIPE ViPipe, CVI_U8 u8Mode)
{
	...
	switch (u8Mode) {
	case WDR_MODE_NONE:
		if (pstSnsState->u8ImgMode == IMX327_MODE_1080P30_WDR)
			pstSnsState->u8ImgMode = IMX327_MODE_1080P30;
		pstSnsState->enWDRMode = WDR_MODE_NONE;
		pstSnsState->u32FLStd = g_astImx327_mode[pstSnsState->u8ImgMode].u32VtsDef;
		g_astImx327_State[ViPipe].u8Hcg = 0x2;
		CVI_TRACE_SNS(CVI_DBG_INFO, "WDR_MODE_NONE\n");
		break;

	case WDR_MODE_2To1_LINE:
		if (pstSnsState->u8ImgMode == IMX327_MODE_1080P30)
			pstSnsState->u8ImgMode = IMX327_MODE_1080P30_WDR;
		pstSnsState->enWDRMode = WDR_MODE_2To1_LINE;
		g_astImx327_State[ViPipe].u8Hcg    = 0x1;
		if (pstSnsState->u8ImgMode == IMX327_MODE_1080P30_WDR) {
			pstSnsState->u32FLStd = g_astImx327_mode[pstSnsState->u8ImgMode].u32VtsDef * 2;
			g_astImx327_State[ViPipe].u32BRL  = g_astImx327_mode[pstSnsState->u8ImgMode].u16BRL;
...
static CVI_S32 cmos_get_sns_regs_info(VI_PIPE ViPipe, ISP_SNS_SYNC_INFO_S *pstSnsSyncInfo)
{
	...
	if ((pstSnsState->bSyncInit == CVI_FALSE) || (pstSnsRegsInfo->bConfig == CVI_FALSE)) {
		...
		pstCfg0->snsCfg.unComBus.s8I2cDev = g_aunImx327_BusInfo[ViPipe].s8I2cDev;
		...
		for (i = 0; i < pstCfg0->snsCfg.u32RegNum; i++) {
			...
			pstI2c_data[i].u8DevAddr = imx327_i2c_addr;
			pstI2c_data[i].u32AddrByteNum = imx327_addr_byte;
			pstI2c_data[i].u32DataByteNum = imx327_data_byte;
		}

		switch (pstSnsState->enWDRMode) {
		case WDR_MODE_2To1_LINE:
			pstI2c_data[DOL2_HOLD].u32RegAddr = IMX327_HOLD_ADDR;
			pstI2c_data[DOL2_HOLD].u32Data = 1;
			pstI2c_data[DOL2_SHS1_0].u32RegAddr = IMX327_SHS1_ADDR;
			pstI2c_data[DOL2_SHS1_1].u32RegAddr = IMX327_SHS1_ADDR + 1;
			pstI2c_data[DOL2_SHS1_2].u32RegAddr = IMX327_SHS1_ADDR + 2;

			pstI2c_data[DOL2_GAIN].u32RegAddr = IMX327_GAIN_ADDR;
			pstI2c_data[DOL2_HCG].u32RegAddr = IMX327_HCG_ADDR;
			pstI2c_data[DOL2_HCG].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_GAIN1].u32RegAddr = IMX327_GAIN1_ADDR;
			pstI2c_data[DOL2_RHS1_0].u32RegAddr = IMX327_RHS1_ADDR;
			pstI2c_data[DOL2_RHS1_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_1].u32RegAddr = IMX327_RHS1_ADDR + 1;
			pstI2c_data[DOL2_RHS1_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_RHS1_2].u32RegAddr = IMX327_RHS1_ADDR + 2;
			pstI2c_data[DOL2_RHS1_2].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_SHS2_0].u32RegAddr = IMX327_SHS2_ADDR;
			pstI2c_data[DOL2_SHS2_1].u32RegAddr = IMX327_SHS2_ADDR + 1;
			pstI2c_data[DOL2_SHS2_2].u32RegAddr = IMX327_SHS2_ADDR + 2;
			pstI2c_data[DOL2_VMAX_0].u32RegAddr = IMX327_VMAX_ADDR;
			pstI2c_data[DOL2_VMAX_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_1].u32RegAddr = IMX327_VMAX_ADDR + 1;
			pstI2c_data[DOL2_VMAX_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_VMAX_2].u32RegAddr = IMX327_VMAX_ADDR + 2;
			pstI2c_data[DOL2_VMAX_2].u8DelayFrmNum = 1;

			pstI2c_data[DOL2_YOUT_SIZE_0].u32RegAddr = IMX327_YOUT_ADDR;
			pstI2c_data[DOL2_YOUT_SIZE_0].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_YOUT_SIZE_1].u32RegAddr = IMX327_YOUT_ADDR + 1;
			pstI2c_data[DOL2_YOUT_SIZE_1].u8DelayFrmNum = 1;
			pstI2c_data[DOL2_REL].u32RegAddr = IMX327_HOLD_ADDR;
			pstI2c_data[DOL2_REL].u32Data = 0;
			pstCfg0->ispCfg.u8DelayFrmNum = 1;
			break;
		default:
			pstI2c_data[LINEAR_HOLD].u32RegAddr = IMX327_HOLD_ADDR;
			pstI2c_data[LINEAR_HOLD].u32Data = 1;
			pstI2c_data[LINEAR_SHS1_0].u32RegAddr = IMX327_SHS1_ADDR;
			pstI2c_data[LINEAR_SHS1_1].u32RegAddr = IMX327_SHS1_ADDR + 1;
			pstI2c_data[LINEAR_SHS1_2].u32RegAddr = IMX327_SHS1_ADDR + 2;
			pstI2c_data[LINEAR_GAIN].u32RegAddr = IMX327_GAIN_ADDR;
			pstI2c_data[LINEAR_HCG].u32RegAddr = IMX327_HCG_ADDR;
			pstI2c_data[LINEAR_HCG].u8DelayFrmNum = 1;
			pstI2c_data[LINEAR_VMAX_0].u32RegAddr = IMX327_VMAX_ADDR;
			pstI2c_data[LINEAR_VMAX_1].u32RegAddr = IMX327_VMAX_ADDR + 1;
			pstI2c_data[LINEAR_VMAX_2].u32RegAddr = IMX327_VMAX_ADDR + 2;
			pstI2c_data[LINEAR_REL].u32RegAddr = IMX327_HOLD_ADDR;
	...
	if (pstSensorImageMode->f32Fps <= 30) {
		if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
			if (IMX327_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX327_MODE_1080P30;
			} else {
			...
			if (IMX327_RES_IS_1080P(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height)) {
				u8SensorImageMode = IMX327_MODE_1080P30_WDR;
				g_astImx327_State[ViPipe].u32BRL = 1109;
			} else {
				CVI_TRACE_SNS(CVI_DBG_ERR, "Not support! Width:%d, Height:%d, Fps:%f, WDRMode:%d\n",
				       pstSensorImageMode->u16Width,
				       pstSensorImageMode->u16Height,
...
static CVI_VOID sensor_mirror_flip(VI_PIPE ViPipe, ISP_SNS_MIRRORFLIP_TYPE_E eSnsMirrorFlip)
{
	...
	if (pstSnsState->bInit == CVI_TRUE && g_aeImx327_MirrorFip[ViPipe] != eSnsMirrorFlip) {
		imx327_mirror_flip(ViPipe, eSnsMirrorFlip);
		g_aeImx327_MirrorFip[ViPipe] = eSnsMirrorFlip;
	}
}
...
static CVI_S32 sensor_rx_attr(VI_PIPE ViPipe, SNS_COMBO_DEV_ATTR_S *pstRxAttr)
{
	...
	memcpy(pstRxAttr, &imx327_rx_attr, sizeof(*pstRxAttr));

	pstRxAttr->img_size.width = g_astImx327_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Width;
	pstRxAttr->img_size.height = g_astImx327_mode[pstSnsState->u8ImgMode].astImg[0].stSnsSize.u32Height;
	if (pstSnsState->enWDRMode == WDR_MODE_NONE) {
...
{
	SNS_COMBO_DEV_ATTR_S *pstRxAttr = &imx327_rx_attr;
	int i;
...
static CVI_S32 imx327_set_bus_info(VI_PIPE ViPipe, ISP_SNS_COMMBUS_U unSNSBusInfo)
{
	g_aunImx327_BusInfo[ViPipe].s8I2cDev = unSNSBusInfo.s8I2cDev;
...
static CVI_S32 sensor_unregister_callback(VI_PIPE ViPipe, ALG_LIB_S *pstAeLib, ALG_LIB_S *pstAwbLib)
{
	...
	//s32Ret = CVI_ISP_SensorUnRegCallBack(ViPipe, IMX327_ID);
	//if (s32Ret != CVI_SUCCESS) {
	//	CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function failed!\n");
	//	return s32Ret;
	//}

	//s32Ret = CVI_AE_SensorUnRegCallBack(ViPipe, pstAeLib, IMX327_ID);
	//if (s32Ret != CVI_SUCCESS) {
	//	CVI_TRACE_SNS(CVI_DBG_ERR, "sensor unregister callback function to ae lib failed!\n");
	//	return s32Ret;
	//}

	//s32Ret = CVI_AWB_SensorUnRegCallBack(ViPipe, pstAwbLib, IMX327_ID);
	//if (s32Ret != CVI_SUCCESS) {
...
static CVI_S32 sensor_set_init(VI_PIPE ViPipe, ISP_INIT_ATTR_S *pstInitAttr)
{
	...
	g_au16Imx327_GainMode[ViPipe] = pstInitAttr->enGainMode;
...
{
	return imx327_probe(ViPipe);
}

ISP_SNS_OBJ_S stSnsImx327_Obj = {
