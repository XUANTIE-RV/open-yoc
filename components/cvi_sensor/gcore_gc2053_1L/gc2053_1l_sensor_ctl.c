...
{
	CVI_U8 i2c_id = (CVI_U8)g_aunGc2053_1l_BusInfo[ViPipe].s8I2cDev;
...
int gc2053_1l_read_register(VI_PIPE ViPipe, int addr)
{
	...
	return sensor_i2c_read(i2c_id, gc2053_1l_i2c_addr, (CVI_U32)addr, gc2053_1l_addr_byte, gc2053_1l_data_byte);
}
...
int gc2053_1l_write_register(VI_PIPE ViPipe, int addr, int data)
{
	...
	return sensor_i2c_write(i2c_id, gc2053_1l_i2c_addr, (CVI_U32)addr, gc2053_1l_addr_byte,
				(CVI_U32)data, gc2053_1l_data_byte);
}
