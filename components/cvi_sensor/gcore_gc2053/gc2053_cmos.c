...
static CVI_U32 regValTable[29][4] = {
	{0x00, 0x00, 0x01, 0x00},
	{0x00, 0x10, 0x01, 0x0c},
	{0x00, 0x20, 0x01, 0x1b},
	{0x00, 0x30, 0x01, 0x2c},
...
static const CVI_U32 gain_table_size = ARRAY_SIZE(gain_table);
...
static CVI_S32 cmos_again_calc_table(VI_PIPE ViPipe, CVI_U32 *pu32AgainLin, CVI_U32 *pu32AgainDb)
{
	...
	if (*pu32AgainLin >= gain_table[gain_table_size - 1]) {
		*pu32AgainDb = gain_table_size - 1;
		*pu32AgainLin = gain_table[gain_table_size - 1];
		return CVI_SUCCESS;
	}
