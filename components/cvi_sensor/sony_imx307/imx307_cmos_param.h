#ifndef __IMX307_CMOS_PARAM_H_
#define __IMX307_CMOS_PARAM_H_
...
static const IMX307_MODE_S g_astImx307_mode[IMX307_MODE_NUM] = {
	[IMX307_MODE_1080P30] = {
		.name = "1080p30",
		.astImg[0] = {
			.stSnsSize = {
...
struct combo_dev_attr_s imx307_rx_attr = {
	...
	.mipi_attr = {
		...
		.lane_id = {2, 1, 3, 0, 4},
		.pn_swap = {0, 0, 0, 0, 0},
		.wdr_mode = CVI_MIPI_WDR_MODE_DOL,//182x is support DOL
	},
	.mclk = {
		.cam = 1,
