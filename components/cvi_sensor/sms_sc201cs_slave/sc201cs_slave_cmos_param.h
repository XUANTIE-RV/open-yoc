#ifndef __SC201CS_SLAVE_CMOS_PARAM_H_
#define __SC201CS_SLAVE_CMOS_PARAM_H_
...
struct combo_dev_attr_s sc201cs_slave_rx_attr = {
...
#endif /* __SC201CS_SLAVE_CMOS_PARAM_H_ */
