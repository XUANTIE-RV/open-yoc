...
#ifdef CONFIG_MESH_MODEL_TRANS
u32_t TRANS_TIMES[] = {TRANSITION_TIME_UNIT_1, TRANSITION_TIME_UNIT_2, TRANSITION_TIME_UNIT_3, TRANSITION_TIME_UNIT_4};
...
//unit is 1ms
u32_t sig_model_transition_get_transition_time(uint8_t byte)
{
