...
#define BT_LE_CONN_INT_MIN 6     // 7.5ms in 1.25ms
#define BT_LE_CONN_INT_MAX 3200  // 4s in 1.25ms
#define BT_LE_CONN_LAT_MIN 0
#define BT_LE_CONN_LAT_MAX 499
#define BT_LE_CONN_TO_MIN  10    // 100ms in 10ms
#define BT_LE_CONN_TO_MAX  3200  // 32s in 10ms
