...
typedef enum IOT_RETURN_CODES {
    ...
    ERROR_SUBDEV_CONNECT_RESPONSE_CODE_TOTAL_OVERLIMIT = -22,
    ERROR_SUBDEV_CONNECT_RESPONSE_CODE_CLOUD_ERR = -21,
    ERROR_SUBDEV_CONNECT_RESPONSE_CODE_INVALI_REQUEST = -20,
