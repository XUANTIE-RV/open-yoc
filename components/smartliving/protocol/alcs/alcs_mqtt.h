...
typedef struct {
    ...
    char device_name[DEVICE_ID_LEN + 1];
    uint32_t send_id;
} alcs_mqtt_ctx_t;
...
#define ALCS_MQTT_THING_LAN_PREFIX_BLACKLIST_UPDATE_REPLY_FMT  "/thing/lan/blacklist/update_reply"
    ...
    #define ALCS_GROUP_ARRAY_SIZE   2
    #define ALCS_GROUP_GID_SIZE     8
    #define ALCS_GROUP_GAK_SIZE     8
    #define ALCS_GROUP_GAS_SIZE     10
    #define ALCS_GROUP_GBL_MAXSIZE     30
    #define ALCS_GROUP_KV_MAXSIZE     (ALCS_GROUP_GID_SIZE+ALCS_GROUP_GAK_SIZE+ALCS_GROUP_GAS_SIZE+ALCS_GROUP_GBL_MAXSIZE+1)*ALCS_GROUP_ARRAY_SIZE
#endif
