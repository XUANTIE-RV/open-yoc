 ...
 */
void ota_ais_disconnect(uint8_t reason);
...
int ota_ais_state_set(uint8_t state);

uint8_t ota_ais_state_get(void);

void ota_ais_notify(uint8_t msg_id, uint8_t cmd, uint8_t *p_msg, uint16_t len);
