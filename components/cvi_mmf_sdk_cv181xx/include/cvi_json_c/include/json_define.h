#ifndef _json_define_h
#define _json_define_h

/* Enable RDRAND Hardware RNG Hash Seed */
/* #undef ENABLE_RDRAND */

/* Override cvi_json_c_get_random_seed() with custom code */
...
/* #define cvi_json_c_strtoll strtoll*/
#endif

#define HAVE_STRTOULL
#if !defined(HAVE_STRTOULL)
#define strtoull strtoull
/* #define cvi_json_c_strtoull strtoull */
#endif

/* Have __thread */
//#define HAVE___THREAD

/* Public define for cvi_json_inttypes.h */
#define JSON_C_HAVE_INTTYPES_H 1

/* Name of package */
#define PACKAGE "cvi_json-c"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "cvi_json-c@googlegroups.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "cvi_json-c"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "cvi_json-c 0.15.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cvi_json-c"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/cvi_json-c/cvi_json-c"
