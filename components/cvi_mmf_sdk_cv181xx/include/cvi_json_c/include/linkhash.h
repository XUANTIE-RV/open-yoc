/*
 * $Id: cvi_linkhash.h,v 1.6 2006/01/30 23:07:57 mclark Exp $
 *
...
/**
 * @file
 * @brief Internal methods for working with cvi_json_type_object objects.  Although
 *        this is exposed by the cvi_json_object_get_object() function and within the
 *        cvi_json_object_iter type, it is not recommended for direct use.
 */
#ifndef _cvi_json_c_linkhash_h_
#define _cvi_json_c_linkhash_h_
 ...
 * when cvi_lh_table_free or lh_table_delete is called.
 ...
 */
extern struct lh_table *cvi_lh_table_new(int size, lh_entry_free_fn *free_fn, lh_hash_fn *hash_fn,
                                     lh_equal_fn *equal_fn);
 ...
 * 	On error, a null pointer is returned.
 */
extern struct lh_table *cvi_lh_kchar_table_new(int size, lh_entry_free_fn *free_fn);
 ...
 */
extern void cvi_lh_table_free(struct lh_table *t);
 ...
 */
extern int cvi_lh_table_insert_w_hash(struct lh_table *t, const void *k, const void *v,
 ...
 */
extern struct lh_entry *cvi_lh_table_lookup_entry(struct lh_table *t, const void *k);
 ...
 * @return a pointer to the record structure of the value or NULL if it does not exist.
 */
extern struct lh_entry *cvi_lh_table_lookup_entry_w_hash(struct lh_table *t, const void *k,
 ...
 */
extern cvi_json_bool cvi_lh_table_lookup_ex(struct lh_table *t, const void *k, void **v);
...
/**
 * @deprecated Don't use this outside of cvi_linkhash.h:
 */
