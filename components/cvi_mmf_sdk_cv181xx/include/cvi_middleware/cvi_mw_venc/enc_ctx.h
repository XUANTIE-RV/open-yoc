...
typedef struct _venc_vid_ctx {
	CVI_VOID (*setInitCfgFixQp)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgCbr)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgVbr)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgAVbr)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgQpMap)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgUbr)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
	CVI_VOID (*setInitCfgRc)(cviInitEncConfig *pInitEncCfg, CVI_VOID *pchnctx);
...
typedef struct _venc_enc_ctx_base {
	...
	CVI_S32 (*encOnePic)(CVI_VOID *ctx, const VIDEO_FRAME_INFO_S *pstFrame, CVI_S32 s32MilliSec);
	CVI_S32 (*getStream)(CVI_VOID *ctx, VENC_STREAM_S *pstStream, CVI_S32 s32MIlliSec);
