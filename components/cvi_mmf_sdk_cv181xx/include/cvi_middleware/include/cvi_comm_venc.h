...
#define CVI_VENC_DUMP_YUV(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_DUMP_YUV) \
			printf("[DYUV] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)

#define CVI_VENC_DUMP_BS(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_DUMP_BS) \
			printf("[DBS] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)
...
#define CVI_VENC_FRC(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_FRC) \
			printf("[FRC] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)
#define CVI_VENC_BIND(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_BIND) \
			printf("[BIND] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)
...
#define CVI_VENC_SYNC(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_SYNC) \
			printf("[SYNC] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)
#define CVI_VENC_TRACE(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_TRACE) \
...
#define CVI_VENC_DUMP_YUV(msg, ...)	\
	do { \
		if (vencDbg.currMask & CVI_VENC_MASK_DUMP_YUV) \
			printf("[YUV] %s = %d, "msg, __func__, __LINE__, ## __VA_ARGS__); \
	} while (0)
...
#define ENUM_ERR_VENC_INVALID_CHNID CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define ENUM_ERR_VENC_VENC_INIT CVI_DEF_ERR(CVI_ID_VENC, EN_ERR_LEVEL_ERROR, 64)
