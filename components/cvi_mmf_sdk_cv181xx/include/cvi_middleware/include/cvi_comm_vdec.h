...
#define ENUM_ERR_VDEC_INVALID_CHNID CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define ENUM_ERR_VDEC_ERR_INIT CVI_DEF_ERR(CVI_ID_VDEC, EN_ERR_LEVEL_ERROR, 64)
