...
CVI_RC CVI_RT_MemFlushAddr(CVI_RT_HANDLE rt_handle, uint64_t paddr, uint64_t len);
CVI_RC CVI_RT_MemInvldAddr(CVI_RT_HANDLE rt_handle, uint64_t paddr, uint64_t len);
