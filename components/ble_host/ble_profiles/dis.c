...
GATT_SERVICE_STATIC_DEFINE(dis_service, [DIS_IDX_SVC] = GATT_PRIMARY_SERVICE_DEFINE(UUID_DIS),
                           ...
                           [DIS_IDX_REGU_LIST_CHAR]
                           = GATT_CHAR_DEFINE(UUID_IEEE_REGULATORY_CERTIFICATION_DATA_LIST, GATT_CHRC_PROP_READ),
                           [DIS_IDX_REGU_LIST_VAL]
                           = GATT_CHAR_VAL_DEFINE(UUID_IEEE_REGULATORY_CERTIFICATION_DATA_LIST, GATT_PERM_READ),
...
static void event_char_read(ble_event_en event, void *event_data)
{
    ...
    switch (dis_char_idx) {
        ...
        case DIS_IDX_PNP_ID_VAL: {
            ...
            break;
            default:
                LOGW(TAG, "Unhandle idx 0x%x", dis_char_idx);
                break;
        }
    }
