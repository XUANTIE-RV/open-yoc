...
#define BT_HCI_EIR_DATA_MAX_SIZE               (240)
#define BT_HCI_OP_READ_EXT_INQUIRY_RESPONSE    BT_OP(BT_OGF_BASEBAND, 0x0051)
struct bt_hci_cp_read_ext_inquiry_response {
	u8_t  status;
	u8_t fec_required;
	u8_t eir_data[BT_HCI_EIR_DATA_MAX_SIZE];
} __packed;

#define BT_HCI_OP_WRITE_EXT_INQUIRY_RESPONSE    BT_OP(BT_OGF_BASEBAND, 0x0052)
...
#define BT_HCI_LE_ADV_EVT_TYPE_EXT_INCOMPLETE            BIT(5)
#define BT_HCI_LE_ADV_EVT_TYPE_EXT_TRUNCATED             BIT(6)
