...
/* Maximum number of simultaneous Bluetooth BREDR connections supported. */
#ifndef CONFIG_BT_BR_MAX_CONN
#define CONFIG_BT_BR_MAX_CONN 1
#endif
...
/* Maximum number of simultaneous Bluetooth synchronous connections
          supported. The minimum (and default) number is 1. 1 ~ 3 */
...
#ifndef CONFIG_BT_HFP_AUDIO_I2S
#define CONFIG_BT_HFP_AUDIO_I2S 1
#endif
#endif
...
#ifdef CONFIG_BT_L2CAP_RX_MTU
#define CONFIG_BT_RFCOMM_L2CAP_MTU CONFIG_BT_L2CAP_RX_MTU
#else
#define CONFIG_BT_RFCOMM_L2CAP_MTU 65
#endif
#endif
...
#if defined(CONFIG_BT_A2DP) && CONFIG_BT_A2DP
/* This option enables A2DP audio output inside stack */
#ifndef CONFIG_BT_A2DP_AUDIO_OUTPUT_INSIDE
#define CONFIG_BT_A2DP_AUDIO_OUTPUT_INSIDE 1
#endif
/* This option enables AVRCP target set volume inside stack for set abslute volume command from controller */
#ifndef CONFIG_BT_AVRCP_VOL_CONTROL
#define CONFIG_BT_AVRCP_VOL_CONTROL 1
#endif
#endif

#if defined(CONFIG_BT_A2DP) && CONFIG_BT_A2DP
#ifndef CONFIG_BT_A2DP_DECODE_SBC
/* This option enables sbc decode */
#define CONFIG_BT_A2DP_DECODE_SBC 1
#endif
#endif
...
/* Number of Enhanced ATT bearers available. 1~16 */
...
/* 	  L2CAP server required security level of EATT bearers:
          ...
          Level 4 (BT_SECURITY_L4) = Secure connection required, 1~4 */
#ifndef CONFIG_BT_EATT_SEC_LEVEL
#define CONFIG_BT_EATT_SEC_LEVEL 1
#endif

#endif //#ifdef CONFIG_BT_EATT && CONFIG_BT_EATT

#endif //#ifdef CONFIG_BT_L2CAP_DYNAMIC_CHANNEL && CONFIG_BT_L2CAP_DYNAMIC_CHANNEL
