...
int tcpclient(struct iperf_param *param)
{
    int                 iCounter;
...
int tcpserver(struct iperf_param *param)
{
    struct sockaddr_in  sAddr;
...
int udpclient(struct iperf_param *param)
{
    int cli_sockfd;
    socklen_t addrlen;
...
int udpserver(struct iperf_param *param)
{
    int ser_sockfd;
    socklen_t addrlen;
...
void test_iperf_register_cmd(void)
{
