...
extern void audio_dev_proc(const uint8_t *data, uint32_t len);
extern void audio_player(uint8_t action);
extern void audio_dev_set_rate(uint32_t rate, uint32_t bitwith, uint32_t channel);
