#!/bin/bash
###attention: do_build.sh in demo bare_xxx should keep same with solutions/bare_helloworld/do_build.sh for xt-rtos sdk
...
make -j${nproc} cpu=$1 board=$2 rtos="" toolchain=gcc libc=$3
