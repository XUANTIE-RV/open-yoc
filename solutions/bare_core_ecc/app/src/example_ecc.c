 ...
 */
    ...
    || CONFIG_CPU_XUANTIE_C910V2 || CONFIG_CPU_XUANTIE_C910V3 || CONFIG_CPU_XUANTIE_C910V3_CP || CONFIG_CPU_XUANTIE_C910V3_CP_XT \
...
volatile ecc_stats_t g_ecc_stats = {0, 0, -1, -1};
