...
#define CONFIG_PER_DMAC_CHANNEL_NUM 4
...
#define CSKY_TIPC_MOUDULE_NUM   17
...
typedef enum {
    ...
    DWENUM_DMA_UART1_TX,
    DWENUM_DMA_UART1_RX,
    DWENUM_DMA_CODEC_REQ0 = 0,
    DWENUM_DMA_CODEC_REQ1,
    DWENUM_DMA_CODEC_REQ4,
    DWENUM_DMA_CODEC_REQ5,
    DWENUM_DMA_UART2_TX,
    DWENUM_DMA_UART2_RX,
    DWENUM_DMA_USI2_TX,
    DWENUM_DMA_USI2_RX,
