 ...
 *              equal to 0.
 */
int xnnl_ref_scatter_nd_fp32(float *input, int32_t *indices, float *updates, float *output,
 ...
 *              equal to 0.
 */
int xnnl_ref_scatter_nd_fp16(__fp16 *input, int32_t *indices, __fp16 *updates, __fp16 *output,
                             int32_t *shape_in, int32_t dim_in, int32_t *shape_indices,
                             int32_t dim_indices, int32_t *shape_updates, int32_t dim_updates);
 ...
 *              equal to 0.
 */
int xnnl_ref_expand_fp32(float *input, float *output, int32_t *shape_in, int32_t dim_in,
 ...
 *              equal to 0.
 */
int xnnl_ref_expand_fp16(__fp16 *input, __fp16 *output, int32_t *shape_in, int32_t dim_in,
                         int32_t *shape_tar, int32_t dim_tar);
/**
 * @}
 */
