...
#if 0 // only for test
      // device is dynamically registered to cloud, that means gw dont't need to save ds of each device
      // g_gateway_subdev_info[0] reserved for gateway itself
            iotx_linkkit_dev_meta_info_t *p_subdev = &(g_gateway_subdev_info->subdev_info[1].meta);
            g_gateway_subdev_info->subdev_info[1].cloud_devid = GATEWAY_NODE_UNREG;
            strcpy(p_subdev->device_name, "00e04c000002");
            //strcpy(p_subdev->device_secret, "a7bf07f7915fd45281aaa37ece7ebdc1");
            strcpy(p_subdev->product_key, "a1faJDbzH2E");
            strcpy(p_subdev->product_secret, "SLEKF6F3L4xtI8yS");
            gateway_get_subdev_kv_string(1, key_string);
            ret = aos_kv_set(key_string, &(g_gateway_subdev_info->subdev_info[1]), sizeof(subdev_info_t), 1);
    
            g_gateway_subdev_info->subdev_info[2].cloud_devid = GATEWAY_NODE_UNREG;
            p_subdev = &(g_gateway_subdev_info->subdev_info[2].meta);
            strcpy(p_subdev->device_name, "00e04c000003");
            //strcpy(p_subdev->device_secret, "3397df4937f2063e8ad7d16d51b6d9fa");
            strcpy(p_subdev->product_key, "a1faJDbzH2E");
            strcpy(p_subdev->product_secret, "SLEKF6F3L4xtI8yS");
            gateway_get_subdev_kv_string(2, key_string);
            ret = aos_kv_set(key_string, &(g_gateway_subdev_info->subdev_info[2]), sizeof(subdev_info_t), 1);
    
            g_gateway_subdev_info->subdev_info[3].cloud_devid = GATEWAY_NODE_UNREG;
            p_subdev = &(g_gateway_subdev_info->subdev_info[3].meta);
            strcpy(p_subdev->device_name, "00e04c000004");
            //strcpy(p_subdev->device_secret, "113cf5dbd2ca46ff4a1174204da92804");
            strcpy(p_subdev->product_key, "a1faJDbzH2E");
            strcpy(p_subdev->product_secret, "SLEKF6F3L4xtI8yS");
            gateway_get_subdev_kv_string(3, key_string);
            ret = aos_kv_set(key_string, &(g_gateway_subdev_info->subdev_info[3]), sizeof(subdev_info_t), 1);
#endif
