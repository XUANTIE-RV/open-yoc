...
#if defined(CONFIG_ALG_US) && CONFIG_ALG_US
bool      us_offline_result;
bool      us_online_result;
#endif
...
#if defined(CONFIG_ALG_US) && CONFIG_ALG_US
            us_offline_result=false;
            us_online_result=false;
#endif
...
#if defined(CONFIG_ALG_US) && CONFIG_ALG_US
            if(us_offline_result==false&&us_online_result==false){
