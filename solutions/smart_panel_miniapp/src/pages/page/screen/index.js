...
class PageScreen extends $falcon.Page {
  /**
   * 构造函数,页面生命周期内只执行一次
   */
  constructor() {
  ...
  onNewOptions(options) {
    ...
    console.log("screen onNewOptions:"+"enter sound again");
  }
