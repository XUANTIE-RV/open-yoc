...
class PageIndex extends $falcon.Page {
  ...
  onNewOptions(options) {
    ...
    console.log("voice_baby onNewOptions:"+"enter voice again");
  }
  ...
  onShow() {
    ...
    // this.$root.sayHello();
    console.log("voice_baby onShow");
    // let res = await fota.start();
    // /*异步函数，需要await等待返回值*/
    //console.log("voice_baby onShow:"+"StartFota res=" + res);
  }
   ...
   */
  async onUnload() {
    console.log("voice_baby onUnload");
  }
