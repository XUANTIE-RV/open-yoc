...
class PageSys extends $falcon.Page {
  /**
   * 构造函数,页面生命周期内只执行一次
   */
  constructor() {
  ...
  onNewOptions(options) {
    ...
    console.log("sys onNewOptions:"+"enter voice again");
  }
  ...
  onShow() {
    ...
    // this.$root.sayHello();
    console.log("sys onShow");
    // let res = await fota.start();
    // /*异步函数，需要await等待返回值*/
    //console.log("sys onShow:"+"StartFota res=" + res);
  }
   ...
   */
  async onUnload() {
    console.log("sys onUnload");
  }

}
export default PageSys;