...
class PageMesh extends $falcon.Page {
  /**
   * 构造函数,页面生命周期内只执行一次
   */
  constructor() {
  ...
  onNewOptions(options) {
    ...
    console.log("mesh_ctrl onNewOptions:"+"enter mesh again");
  }
  ...
  onShow() {
    ...
    // this.$root.sayHello();
    console.log("mesh_ctrl onShow");
    // let res = await fota.start();
    // /*异步函数，需要await等待返回值*/
    //console.log("mesh_ctrl onShow:"+"StartFota res=" + res);
  }
   ...
   */
  async onUnload() {
    console.log("mesh_ctrl onUnload");
  }
