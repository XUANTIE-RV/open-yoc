...
`osal_semihost2` 是一个玄铁RTOS SDK中使用osal封装的semihost2示例，使用来自zephyr的semihost三方库。
...
qemu-system-riscv64 -machine xiaohui -cpu c907fdvm -nographic -semihosting -kernel yoc.elf
```
...
```
osal_semihost2 demo runs successfully!
