...
#if defined(BOARD_BUTTON_ADC_NUM) && BOARD_BUTTON_ADC_NUM
...
static button_adc_conf_t button_adc_confs[] = {
    ...
    },
    {
        BUTTON_ID_VOL_DOWN,
        BUTTON_ADC_CHN_DOWN,
        BUTTON_ADC_VALUE_VOL_DOWN,
        BUTTON_ADC_VALUE_VOL_DOWN_RANGE,
    },
    {
        BUTTON_ID_MUTE,
        BUTTON_ADC_CHN_MUTE,
...
void app_button_init(void)
{
    ...
    for (int i = 0; i < sizeof(button_event_confs) / sizeof(button_event_conf_t); i++) {
        ...
        button_add_event(button_event_confs[i].keymsg_id, b_tbl, sizeof(b_tbl) / sizeof(button_evt_t), app_key_msg_send, "");
    }
}
#endif