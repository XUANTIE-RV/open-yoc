...
#define WHETSTONE_LOOP_MAX (10000)
#else
#define WHETSTONE_LOOP_MAX (4000)
#endif
...
#endif
{
	...
	loopstart = WHETSTONE_LOOP_MAX;		/* see the note about LOOP below */
	continuous = 0;
...
*/
	...
	KIPS = (100.0*LOOP*II)*1000000.0/(float)(finisec-startsec);
	if (KIPS >= 1000.0)
	...
	if (continuous)
        ...
        printf("bare_whetstone runs success!\n");
	return(0);
}
