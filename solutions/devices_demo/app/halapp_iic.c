...
int devfs_iic_demo(APP_TEST_IIC_FUNCTION function, uint8_t gpio_pin0, uint8_t gpio_pin1)
{
    ...
    if (ret < 0) {
        printf("IIC_IOC_SET_CONFIG fail !\n");
        goto failure;
    }
    ...
    case APP_TEST_IIC_MASTER_SEND:
        ...
        if (ret < 0) {
            printf("IIC_IOC_MASTER_SEND fail !\n");
            goto failure;
        }
    ...
    case APP_TEST_IIC_SLAVE_RECV:
        ...
        if (ret < 0) {
            printf("IIC_IOC_SLAVE_RECV fail !\n");
            goto failure;
        }
    ...
    case APP_TEST_IIC_MASTER_RECV:
        ...
        if (ret < 0) {
            printf("IIC_IOC_MASTER_RECV fail !\n");
            goto failure;
        }
    ...
    case APP_TEST_IIC_SLAVE_SEND:
        ...
        if (ret < 0) {
            printf("IIC_IOC_SLAVE_SEND fail !\n");
            goto failure;
        }
        break;
#if 0
